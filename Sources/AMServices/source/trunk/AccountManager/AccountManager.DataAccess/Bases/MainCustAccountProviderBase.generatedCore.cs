...
{	
	...
	{		
		...
		/// <returns>Returns true if operation suceeded.</returns>
		public bool Delete(string _mainCustAccountId)
		{
		...
		/// <remarks>Deletes based on primary key(s).</remarks>
		/// <returns>Returns true if operation suceeded.</returns>
		public abstract bool Delete(TransactionManager transactionManager, string _mainCustAccountId);		
		...
		public TList<MainCustAccount> GetByBrokerId(string _brokerId)
		{
			int count = -1;
		...
		/// <returns>Returns a typed collection of AccountManager.Entities.MainCustAccount objects.</returns>
		/// <remarks></remarks>
		public TList<MainCustAccount> GetByBrokerId(TransactionManager transactionManager, string _brokerId)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of AccountManager.Entities.MainCustAccount objects.</returns>
		public TList<MainCustAccount> GetByBrokerId(TransactionManager transactionManager, string _brokerId, int start, int pageLength)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of AccountManager.Entities.MainCustAccount objects.</returns>
		public TList<MainCustAccount> GetByBrokerId(string _brokerId, int start, int pageLength)
		{
			int count =  -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of AccountManager.Entities.MainCustAccount objects.</returns>
		public TList<MainCustAccount> GetByBrokerId(string _brokerId, int start, int pageLength,out int count)
		{
			return GetByBrokerId(null, _brokerId, start, pageLength, out count);	
		}
		...
		/// <returns>Returns a typed collection of AccountManager.Entities.MainCustAccount objects.</returns>
		public abstract TList<MainCustAccount> GetByBrokerId(TransactionManager transactionManager, string _brokerId, int start, int pageLength, out int count);
		...
		public AccountManager.Entities.MainCustAccount GetByMainCustAccountId(string _mainCustAccountId)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="AccountManager.Entities.MainCustAccount"/> class.</returns>
		public AccountManager.Entities.MainCustAccount GetByMainCustAccountId(string _mainCustAccountId, int start, int pageLength)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="AccountManager.Entities.MainCustAccount"/> class.</returns>
		public AccountManager.Entities.MainCustAccount GetByMainCustAccountId(TransactionManager transactionManager, string _mainCustAccountId)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="AccountManager.Entities.MainCustAccount"/> class.</returns>
		public AccountManager.Entities.MainCustAccount GetByMainCustAccountId(TransactionManager transactionManager, string _mainCustAccountId, int start, int pageLength)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="AccountManager.Entities.MainCustAccount"/> class.</returns>
		public AccountManager.Entities.MainCustAccount GetByMainCustAccountId(string _mainCustAccountId, int start, int pageLength, out int count)
		{
			return GetByMainCustAccountId(null, _mainCustAccountId, start, pageLength, out count);
		}
		...
		/// <param name="count">The total number of records.</param>
		/// <returns>Returns an instance of the <see cref="AccountManager.Entities.MainCustAccount"/> class.</returns>
		public abstract AccountManager.Entities.MainCustAccount GetByMainCustAccountId(TransactionManager transactionManager, string _mainCustAccountId, int start, int pageLength, out int count);
		...
		public static TList<MainCustAccount> Fill(IDataReader reader, TList<MainCustAccount> rows, int start, int pageLength)
		{
			...
			for (int i = 0; i < pageLength; i++)
			{
				...
				if (useEntityFactory)
				{
					...
					.Append("|").Append((string)reader[((int)MainCustAccountColumn.MainCustAccountId - 1)]).ToString();
					...
					))
				{
					...
					c.MainCustAccountId = (string)reader[((int)MainCustAccountColumn.MainCustAccountId - 1)];
					c.OriginalMainCustAccountId = c.MainCustAccountId;
					c.FullName = (reader.IsDBNull(((int)MainCustAccountColumn.FullName - 1)))?null:(string)reader[((int)MainCustAccountColumn.FullName - 1)];
					c.Email = (reader.IsDBNull(((int)MainCustAccountColumn.Email - 1)))?null:(string)reader[((int)MainCustAccountColumn.Email - 1)];
					c.Phone = (reader.IsDBNull(((int)MainCustAccountColumn.Phone - 1)))?null:(string)reader[((int)MainCustAccountColumn.Phone - 1)];
					c.Actived = (bool)reader[((int)MainCustAccountColumn.Actived - 1)];
					c.Password = (reader.IsDBNull(((int)MainCustAccountColumn.Password - 1)))?null:(string)reader[((int)MainCustAccountColumn.Password - 1)];
					c.Pin = (reader.IsDBNull(((int)MainCustAccountColumn.Pin - 1)))?null:(string)reader[((int)MainCustAccountColumn.Pin - 1)];
					...
					c.TokenId = (reader.IsDBNull(((int)MainCustAccountColumn.TokenId - 1)))?null:(string)reader[((int)MainCustAccountColumn.TokenId - 1)];
					c.TokenName = (reader.IsDBNull(((int)MainCustAccountColumn.TokenName - 1)))?null:(string)reader[((int)MainCustAccountColumn.TokenName - 1)];
					c.TokenActived = (reader.IsDBNull(((int)MainCustAccountColumn.TokenActived - 1)))?null:(string)reader[((int)MainCustAccountColumn.TokenActived - 1)];
					c.BrokerId = (reader.IsDBNull(((int)MainCustAccountColumn.BrokerId - 1)))?null:(string)reader[((int)MainCustAccountColumn.BrokerId - 1)];
					...
					c.CustomerType = (int)reader[((int)MainCustAccountColumn.CustomerType - 1)];
					c.AuthType = (short)reader[((int)MainCustAccountColumn.AuthType - 1)];
					c.PinType = (short)reader[((int)MainCustAccountColumn.PinType - 1)];
					c.LanguageId = (System.String)reader[((int)MainCustAccountColumn.LanguageId - 1)];
					...
					c.CreatedUser = (string)reader[((int)MainCustAccountColumn.CreatedUser - 1)];
					c.UpdatedUser = (reader.IsDBNull(((int)MainCustAccountColumn.UpdatedUser - 1)))?null:(string)reader[((int)MainCustAccountColumn.UpdatedUser - 1)];
		...
		public static void RefreshEntity(IDataReader reader, AccountManager.Entities.MainCustAccount entity)
		{
			...
			entity.MainCustAccountId = (string)reader[((int)MainCustAccountColumn.MainCustAccountId - 1)];
			entity.OriginalMainCustAccountId = (string)reader["MainCustAccountID"];
			entity.FullName = (reader.IsDBNull(((int)MainCustAccountColumn.FullName - 1)))?null:(string)reader[((int)MainCustAccountColumn.FullName - 1)];
			entity.Email = (reader.IsDBNull(((int)MainCustAccountColumn.Email - 1)))?null:(string)reader[((int)MainCustAccountColumn.Email - 1)];
			entity.Phone = (reader.IsDBNull(((int)MainCustAccountColumn.Phone - 1)))?null:(string)reader[((int)MainCustAccountColumn.Phone - 1)];
			entity.Actived = (bool)reader[((int)MainCustAccountColumn.Actived - 1)];
			entity.Password = (reader.IsDBNull(((int)MainCustAccountColumn.Password - 1)))?null:(string)reader[((int)MainCustAccountColumn.Password - 1)];
			entity.Pin = (reader.IsDBNull(((int)MainCustAccountColumn.Pin - 1)))?null:(string)reader[((int)MainCustAccountColumn.Pin - 1)];
			...
			entity.TokenId = (reader.IsDBNull(((int)MainCustAccountColumn.TokenId - 1)))?null:(string)reader[((int)MainCustAccountColumn.TokenId - 1)];
			entity.TokenName = (reader.IsDBNull(((int)MainCustAccountColumn.TokenName - 1)))?null:(string)reader[((int)MainCustAccountColumn.TokenName - 1)];
			entity.TokenActived = (reader.IsDBNull(((int)MainCustAccountColumn.TokenActived - 1)))?null:(string)reader[((int)MainCustAccountColumn.TokenActived - 1)];
			entity.BrokerId = (reader.IsDBNull(((int)MainCustAccountColumn.BrokerId - 1)))?null:(string)reader[((int)MainCustAccountColumn.BrokerId - 1)];
			...
			entity.CustomerType = (int)reader[((int)MainCustAccountColumn.CustomerType - 1)];
			entity.AuthType = (short)reader[((int)MainCustAccountColumn.AuthType - 1)];
			entity.PinType = (short)reader[((int)MainCustAccountColumn.PinType - 1)];
			entity.LanguageId = (System.String)reader[((int)MainCustAccountColumn.LanguageId - 1)];
			...
			entity.CreatedUser = (string)reader[((int)MainCustAccountColumn.CreatedUser - 1)];
			entity.UpdatedUser = (reader.IsDBNull(((int)MainCustAccountColumn.UpdatedUser - 1)))?null:(string)reader[((int)MainCustAccountColumn.UpdatedUser - 1)];
		...
		public static void RefreshEntity(DataSet dataSet, AccountManager.Entities.MainCustAccount entity)
		{
			...
			entity.OriginalMainCustAccountId = (string)dataRow["MainCustAccountID"];
			entity.FullName = Convert.IsDBNull(dataRow["FullName"]) ? null : (string)dataRow["FullName"];
			entity.Email = Convert.IsDBNull(dataRow["Email"]) ? null : (string)dataRow["Email"];
			entity.Phone = Convert.IsDBNull(dataRow["Phone"]) ? null : (string)dataRow["Phone"];
			entity.Actived = (bool)dataRow["Actived"];
			entity.Password = Convert.IsDBNull(dataRow["Password"]) ? null : (string)dataRow["Password"];
			entity.Pin = Convert.IsDBNull(dataRow["PIN"]) ? null : (string)dataRow["PIN"];
			...
			entity.TokenId = Convert.IsDBNull(dataRow["TokenID"]) ? null : (string)dataRow["TokenID"];
			entity.TokenName = Convert.IsDBNull(dataRow["TokenName"]) ? null : (string)dataRow["TokenName"];
			entity.TokenActived = Convert.IsDBNull(dataRow["TokenActived"]) ? null : (string)dataRow["TokenActived"];
			...
			entity.CustomerType = (int)dataRow["CustomerType"];
			entity.AuthType = (short)dataRow["AuthType"];
			entity.PinType = (short)dataRow["PinType"];
			...
			entity.CreatedUser = (string)dataRow["CreatedUser"];
			entity.UpdatedUser = Convert.IsDBNull(dataRow["UpdatedUser"]) ? null : (string)dataRow["UpdatedUser"];
