...
{	
	...
	///</summary>
	public abstract partial class LanguageProviderBaseCore : EntityProviderBase<AccountManager.Entities.Language, AccountManager.Entities.LanguageKey>
	{		
		...
		public override bool Delete(TransactionManager transactionManager, AccountManager.Entities.LanguageKey key)
		{
		...
		public override AccountManager.Entities.Language Get(TransactionManager transactionManager, AccountManager.Entities.LanguageKey key, int start, int pageLength)
		{
		...
		/// <returns>Returns an instance of the <see cref="AccountManager.Entities.Language"/> class.</returns>
		public AccountManager.Entities.Language GetByLanguageId(System.String _languageId)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="AccountManager.Entities.Language"/> class.</returns>
		public AccountManager.Entities.Language GetByLanguageId(System.String _languageId, int start, int pageLength)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="AccountManager.Entities.Language"/> class.</returns>
		public AccountManager.Entities.Language GetByLanguageId(TransactionManager transactionManager, System.String _languageId)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="AccountManager.Entities.Language"/> class.</returns>
		public AccountManager.Entities.Language GetByLanguageId(TransactionManager transactionManager, System.String _languageId, int start, int pageLength)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="AccountManager.Entities.Language"/> class.</returns>
		public AccountManager.Entities.Language GetByLanguageId(System.String _languageId, int start, int pageLength, out int count)
		{
			return GetByLanguageId(null, _languageId, start, pageLength, out count);
		}
		...
		/// <returns>Returns an instance of the <see cref="AccountManager.Entities.Language"/> class.</returns>
		public abstract AccountManager.Entities.Language GetByLanguageId(TransactionManager transactionManager, System.String _languageId, int start, int pageLength, out int count);
		...
		public static TList<Language> Fill(IDataReader reader, TList<Language> rows, int start, int pageLength)
		{
			...
			for (int i = 0; i < pageLength; i++)
			{
				...
				AccountManager.Entities.Language c = null;
				if (useEntityFactory)
				{
				...
				{
					c = new AccountManager.Entities.Language();
				}
					...
					))
				{
					...
					c.LanguageName = (System.String)reader[((int)LanguageColumn.LanguageName - 1)];
		...
		/// <summary>
		/// Refreshes the <see cref="AccountManager.Entities.Language"/> object from the <see cref="IDataReader"/>.
		/// </summary>
		/// <param name="reader">The <see cref="IDataReader"/> to read from.</param>
		/// <param name="entity">The <see cref="AccountManager.Entities.Language"/> object to refresh.</param>
		public static void RefreshEntity(IDataReader reader, AccountManager.Entities.Language entity)
		{
			...
			entity.LanguageName = (System.String)reader[((int)LanguageColumn.LanguageName - 1)];
			entity.AcceptChanges();
		}
		
		/// <summary>
		/// Refreshes the <see cref="AccountManager.Entities.Language"/> object from the <see cref="DataSet"/>.
		/// </summary>
		/// <param name="dataSet">The <see cref="DataSet"/> to read from.</param>
		/// <param name="entity">The <see cref="AccountManager.Entities.Language"/> object.</param>
		public static void RefreshEntity(DataSet dataSet, AccountManager.Entities.Language entity)
		{
		...
		/// </remarks>
		/// <param name="transactionManager"><see cref="TransactionManager"/> object</param>
		/// <param name="entity">The <see cref="AccountManager.Entities.Language"/> object to load.</param>
		/// <param name="deep">Boolean. A flag that indicates whether to recursively save all Property Collection that are descendants of this instance. If True, saves the complete object graph below this object. If False, saves this object only. </param>
		/// <param name="deepLoadType">DeepLoadType Enumeration to Include/Exclude object property collections from Load.</param>
		/// <param name="childTypes">AccountManager.Entities.Language Property Collection Type Array To Include or Exclude from Load</param>
		/// <param name="innerList">A collection of child types for easy access.</param>
	    /// <exception cref="ArgumentNullException">entity or childTypes is null.</exception>
	    /// <exception cref="ArgumentException">deepLoadType has invalid value.</exception>
		public override void DeepLoad(TransactionManager transactionManager, AccountManager.Entities.Language entity, bool deep, DeepLoadType deepLoadType, System.Type[] childTypes, DeepSession innerList)
		{
			if(entity == null)
				return;
		...
		/// <summary>
		/// Deep Save the entire object graph of the AccountManager.Entities.Language object with criteria based of the child 
		/// Type property array and DeepSaveType.
		/// </summary>
		/// <param name="transactionManager">The transaction manager.</param>
		/// <param name="entity">AccountManager.Entities.Language instance</param>
		/// <param name="deepSaveType">DeepSaveType Enumeration to Include/Exclude object property collections from Save.</param>
		/// <param name="childTypes">AccountManager.Entities.Language Property Collection Type Array To Include or Exclude from Save</param>
		/// <param name="innerList">A Hashtable of child types for easy access.</param>
		public override bool DeepSave(TransactionManager transactionManager, AccountManager.Entities.Language entity, DeepSaveType deepSaveType, System.Type[] childTypes, DeepSession innerList)
		{	
			if (entity == null)
				return false;
	...
	/// for child properties in <c>AccountManager.Entities.Language</c>
	///</summary>
