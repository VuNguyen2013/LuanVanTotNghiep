...
namespace AccountManagerWebServices.EtradeService {
    using System;
    ...
    public partial class ETradeServicesWebServices : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        public ETradeServicesWebServices() {
            this.Url = global::AccountManagerWebServices.Properties.Settings.Default.AccountManagerWebServices_EtradeService_ETradeServicesWebServices;
        ...
        /// <remarks/>
        public void PutOrderAsync(int market, string accountNo, string pin, string secSymbol, char side, int volume, decimal price, char conPrice, int accountType) {
            this.PutOrderAsync(market, accountNo, pin, secSymbol, side, volume, price, conPrice, accountType, null);
        }
        
        /// <remarks/>
        public void PutOrderAsync(int market, string accountNo, string pin, string secSymbol, char side, int volume, decimal price, char conPrice, int accountType, object userState) {
            ...
            this.InvokeAsync("PutOrder", new object[] {
                        ...
                        price,
                        conPrice,
                        accountType}, this.PutOrderOperationCompleted, userState);
        }
        ...
        public string GetListConditionOrder(string subAccountId, string side, string symbol, int[] status, string fromDate, string toDate, int pageIndex, int pageSize) {
        ...
        /// <remarks/>
        public void GetListConditionOrderAsync(string subAccountId, string side, string symbol, int[] status, string fromDate, string toDate, int pageIndex, int pageSize) {
            this.GetListConditionOrderAsync(subAccountId, side, symbol, status, fromDate, toDate, pageIndex, pageSize, null);
        }
        
        /// <remarks/>
        public void GetListConditionOrderAsync(string subAccountId, string side, string symbol, int[] status, string fromDate, string toDate, int pageIndex, int pageSize, object userState) {
            ...
            this.InvokeAsync("GetListConditionOrder", new object[] {
                        ...
                        toDate,
                        pageIndex,
                        pageSize}, this.GetListConditionOrderOperationCompleted, userState);
        }
        ...
        /// <remarks/>
        public void GetListBuyRightAsync(string subAccountId, string beginDateToRegister, string endDateToRegister, int pageIndex, int pageSize) {
            this.GetListBuyRightAsync(subAccountId, beginDateToRegister, endDateToRegister, pageIndex, pageSize, null);
        }
        
        /// <remarks/>
        public void GetListBuyRightAsync(string subAccountId, string beginDateToRegister, string endDateToRegister, int pageIndex, int pageSize, object userState) {
        ...
        /// <remarks/>
        public void PutXROrderAsync(string subAccountID, string pin, long buyRightID, string secSymbol, char market, long requestVol, string note) {
            this.PutXROrderAsync(subAccountID, pin, buyRightID, secSymbol, market, requestVol, note, null);
        }
        
        /// <remarks/>
        public void PutXROrderAsync(string subAccountID, string pin, long buyRightID, string secSymbol, char market, long requestVol, string note, object userState) {
