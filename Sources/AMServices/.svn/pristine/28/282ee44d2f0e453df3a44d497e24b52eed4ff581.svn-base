...
namespace AccountManager.UnitTests
{
    ...
    {    	
		/// <summary>
		/// Creates a new <see cref="MainCustAccountTest"/> instance.
		/// </summary>	
		public MainCustAccountTest()
		{				
		}
		...
		/// <summary>
		/// Selects a sample of  MainCustAccount objects of the database.
		/// </summary>
		[NUnit.Framework.Test]
        ...
        ///</summary>
        static public MainCustAccount CreateMockInstance(TransactionManager tm)
        {
            // get the default mock instance
            MainCustAccount mock = MainCustAccountTest.CreateMockInstance_Generated(tm);
        ...
        ///</summary>
        static public void UpdateMockInstance(TransactionManager tm, MainCustAccount mock)
        {
            MainCustAccountTest.UpdateMockInstance_Generated(tm, mock);
        ...
        static private void SetSpecialTestData(MainCustAccount mock)
        {
