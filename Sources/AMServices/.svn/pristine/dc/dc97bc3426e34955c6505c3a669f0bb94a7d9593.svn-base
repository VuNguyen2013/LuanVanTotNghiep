...
namespace AccountManager.DataAccess.SqlClient
{
	...
	public sealed class SqlNetTiersProvider : AccountManager.DataAccess.Bases.NetTiersProvider
	{
		...
		private SqlSmsCountProvider innerSqlSmsCountProvider;

		///<summary>
		/// This class is the Data Access Logic Component for the <see cref="SmsCount"/> business entity.
		/// It exposes CRUD methods as well as selecting on index, foreign keys and custom stored procedures.
		///</summary>
		/// <value></value>
		public override SmsCountProviderBase SmsCountProvider
		{
			get
			{
				if (innerSqlSmsCountProvider == null) 
				{
					lock (syncRoot) 
					{
						if (innerSqlSmsCountProvider == null)
						{
							this.innerSqlSmsCountProvider = new SqlSmsCountProvider(_connectionString, _useStoredProcedure, _providerInvariantName);
						}
					}
				}
				return innerSqlSmsCountProvider;
			}
		}
		
		/// <summary>
		/// Gets the current <c cref="SqlSmsCountProvider"/>.
		/// </summary>
		/// <value></value>
		public SqlSmsCountProvider SqlSmsCountProvider
		{
			get {return SmsCountProvider as SqlSmsCountProvider;}
		}
