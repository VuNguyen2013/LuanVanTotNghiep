...
namespace AccountManager.Entities
{
	...
	{		
		...
		public LanguageBase(System.String _languageId, System.String _languageName)
		{
			this.entityData = new LanguageEntityData();
			this.backupData = null;
		...
		[DescriptionAttribute(@"Language name"), System.ComponentModel.Bindable( System.ComponentModel.BindableSupport.Yes)]
		...
		public override string[] TableColumns
		{
			get
			{
				return new string[] {"LanguageId", "LanguageName"};
			}
		}
		#endregion 
...
/*
        ...
        */
		...
		public override string ToString()
		{
			return string.Format(System.Globalization.CultureInfo.InvariantCulture,
				"{3}{2}- LanguageId: {0}{2}- LanguageName: {1}{2}{4}", 
				this.LanguageId,
				this.LanguageName,
	...
	public enum LanguageColumn : int
	{
		...
		[ColumnEnum("LanguageId", typeof(System.String), System.Data.DbType.AnsiString, true, false, false, 10)]
		LanguageId = 1,
		/// <summary>
		/// LanguageName : Language name
		/// </summary>
		[EnumTextValue("LanguageName")]
		[ColumnEnum("LanguageName", typeof(System.String), System.Data.DbType.String, false, false, false, 255)]
		LanguageName = 2
	}//End enum
