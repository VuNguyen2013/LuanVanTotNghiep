...
namespace AccountManager.Entities
{
	...
	{		
		...
		/// <summary>
		///	Holds a collection of BuyRight objects
		///	which are related to this object through the relation FK_BuyRight_SubCustAccount
		/// </summary>	
		[System.ComponentModel.Bindable(System.ComponentModel.BindableSupport.Yes)]
		public virtual TList<BuyRight> BuyRightCollection
		{
			get { return entityData.BuyRightCollection; }
			set { entityData.BuyRightCollection = value; }	
		}
		...
		protected virtual SubCustAccount Copy(IDictionary existingCopies)
		{
			...
			copy.BuyRightCollection = (TList<BuyRight>) MakeCopyOf(this.BuyRightCollection, existingCopies); 
...
/*
	...
	internal protected class SubCustAccountEntityData : ICloneable, ICloneableEx
	{
		...
		private TList<BuyRight> _buyRightSubCustAccountId;
		...
		public TList<BuyRight> BuyRightCollection
		{
			get
			{
				if (_buyRightSubCustAccountId == null)
				{
				_buyRightSubCustAccountId = new TList<BuyRight>();
				}
	
				return _buyRightSubCustAccountId;
			}
			set { _buyRightSubCustAccountId = value; }
		}
		...
		public Object Clone()
		{
			...
			//deep copy nested objects
			if (this._buyRightSubCustAccountId != null)
				_tmp.BuyRightCollection = (TList<BuyRight>) MakeCopyOf(this.BuyRightCollection); 
		...
		public object Clone(IDictionary existingCopies)
		{
			...
			#region Child Collections
			//deep copy nested objects
			_tmp.BuyRightCollection = (TList<BuyRight>) MakeCopyOf(this.BuyRightCollection, existingCopies); 
