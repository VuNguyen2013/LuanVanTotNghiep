...
namespace InnoStockPortal.Data.SqlClient
{
	...
	/// </summary>
	public sealed class SqlNetTiersProvider : InnoStockPortal.Data.Bases.NetTiersProvider
	{
		...
		private SqlVnindexProvider innerSqlVnindexProvider;

		///<summary>
		/// This class is the Data Access Logic Component for the <see cref="Vnindex"/> business entity.
		/// It exposes CRUD methods as well as selecting on index, foreign keys and custom stored procedures.
		///</summary>
		/// <value></value>
		public override VnindexProviderBase VnindexProvider
		{
			get
			{
				if (innerSqlVnindexProvider == null) 
				{
					lock (syncRoot) 
					{
						if (innerSqlVnindexProvider == null)
						{
							this.innerSqlVnindexProvider = new SqlVnindexProvider(_connectionString, _useStoredProcedure, _providerInvariantName);
						}
					}
				}
				return innerSqlVnindexProvider;
			}
		}
		
		/// <summary>
		/// Gets the current <see cref="SqlVnindexProvider"/>.
		/// </summary>
		/// <value></value>
		public SqlVnindexProvider SqlVnindexProvider
		{
			get {return VnindexProvider as SqlVnindexProvider;}
		}
