...
/*
	...
	Important: Do not modify this file. Edit the file CashAdvance.cs instead.
*/
...
{
	///<summary>
	/// An object representation of the 'CashAdvance' table. [No description found the database]	
	///</summary>
	[Serializable]
	[DataObject, CLSCompliant(true)]
	public abstract partial class CashAdvanceBase : EntityBase, ICashAdvance, IEntityId<CashAdvanceKey>, System.IComparable, System.ICloneable, ICloneableEx, IEditableObject, IComponent, INotifyPropertyChanged
	{		
		...
		/// </summary>
		private CashAdvanceEntityData entityData;
		
		/// <summary>
		/// 	Hold the original data of the entity, as loaded from the repository.
		/// </summary>
		private CashAdvanceEntityData _originalData;
		
		/// <summary>
		/// 	Hold a backup of the inner data of the entity.
		/// </summary>
		private CashAdvanceEntityData backupData; 
		...
		[NonSerialized]
		private TList<CashAdvance> parentCollection;
		...
		/// </summary>
		[field:NonSerialized]
		public event CashAdvanceEventHandler ColumnChanging;		
		
		/// <summary>
		/// Occurs after a value has been changed for the specified column.
		/// </summary>
		[field:NonSerialized]
		public event CashAdvanceEventHandler ColumnChanged;
		
		#endregion Variable Declarations
		
		#region Constructors
		///<summary>
		/// Creates a new <see cref="CashAdvanceBase"/> instance.
		///</summary>
		public CashAdvanceBase()
		{
			this.entityData = new CashAdvanceEntityData();
		...
		public CashAdvanceBase(System.String _subAccountId, System.DateTime _advanceDate, System.String _contractNo, 
			System.Int32? _orderId, System.String _stockSymbol, System.DateTime? _sellDueDate, System.DateTime? _cashDueDate, 
			System.Decimal? _totalSellValue, System.Decimal? _cashAvailable, System.Decimal? _cashRequest, 
			System.Decimal? _fee, System.Decimal? _cashReceived, System.Int32? _status, System.Int32 _tradeType, 
			System.String _brokerId, System.String _reason, System.DateTime? _execTime, System.Decimal? _vat)
		{
			this.entityData = new CashAdvanceEntityData();
			this.backupData = null;
		...
		///<summary>
		/// A simple factory method to create a new <see cref="CashAdvance"/> instance.
		///</summary>
		///<param name="_subAccountId">order id sinh ra tu FIS</param>
		///<param name="_advanceDate">Thoi gian giao dich</param>
		///<param name="_contractNo">So hop dong</param>
		...
		///<param name="_execTime"></param>
		///<param name="_vat"></param>
		public static CashAdvance CreateCashAdvance(System.String _subAccountId, System.DateTime _advanceDate, System.String _contractNo, 
			System.Int32? _orderId, System.String _stockSymbol, System.DateTime? _sellDueDate, System.DateTime? _cashDueDate, 
			System.Decimal? _totalSellValue, System.Decimal? _cashAvailable, System.Decimal? _cashRequest, 
			System.Decimal? _fee, System.Decimal? _cashReceived, System.Int32? _status, System.Int32 _tradeType, 
			System.String _brokerId, System.String _reason, System.DateTime? _execTime, System.Decimal? _vat)
		{
			...
			newCashAdvance.SubAccountId = _subAccountId;
			newCashAdvance.AdvanceDate = _advanceDate;
			newCashAdvance.ContractNo = _contractNo;
			newCashAdvance.OrderId = _orderId;
			newCashAdvance.StockSymbol = _stockSymbol;
			newCashAdvance.SellDueDate = _sellDueDate;
			newCashAdvance.CashDueDate = _cashDueDate;
			newCashAdvance.TotalSellValue = _totalSellValue;
			newCashAdvance.CashAvailable = _cashAvailable;
			newCashAdvance.CashRequest = _cashRequest;
			newCashAdvance.Fee = _fee;
			newCashAdvance.CashReceived = _cashReceived;
			newCashAdvance.Status = _status;
			newCashAdvance.TradeType = _tradeType;
			newCashAdvance.BrokerId = _brokerId;
			newCashAdvance.Reason = _reason;
			newCashAdvance.ExecTime = _execTime;
			newCashAdvance.Vat = _vat;
		...
		public virtual System.Int64 Id
		{
			...
			set
			{
				...
				OnColumnChanging(CashAdvanceColumn.Id, this.entityData.Id);
				this.entityData.Id = value;
				this.EntityId.Id = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(CashAdvanceColumn.Id, this.entityData.Id);
		...
		public virtual System.String SubAccountId
		{
			...
			set
			{
				...
				OnColumnChanging(CashAdvanceColumn.SubAccountId, this.entityData.SubAccountId);
				this.entityData.SubAccountId = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(CashAdvanceColumn.SubAccountId, this.entityData.SubAccountId);
		...
		public virtual System.DateTime AdvanceDate
		{
			...
			set
			{
				...
				OnColumnChanging(CashAdvanceColumn.AdvanceDate, this.entityData.AdvanceDate);
				this.entityData.AdvanceDate = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(CashAdvanceColumn.AdvanceDate, this.entityData.AdvanceDate);
		...
		[DescriptionAttribute(@"So hop dong"), System.ComponentModel.Bindable( System.ComponentModel.BindableSupport.Yes)]
		...
		public virtual System.String ContractNo
		{
			...
			set
			{
				...
				OnColumnChanging(CashAdvanceColumn.ContractNo, this.entityData.ContractNo);
				this.entityData.ContractNo = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(CashAdvanceColumn.ContractNo, this.entityData.ContractNo);
		...
		public virtual System.Int32? OrderId
		{
			...
			set
			{
				...
				OnColumnChanging(CashAdvanceColumn.OrderId, this.entityData.OrderId);
				this.entityData.OrderId = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(CashAdvanceColumn.OrderId, this.entityData.OrderId);
		...
		[DescriptionAttribute(@"Ma co phieu"), System.ComponentModel.Bindable( System.ComponentModel.BindableSupport.Yes)]
		...
		public virtual System.String StockSymbol
		{
			...
			set
			{
				...
				OnColumnChanging(CashAdvanceColumn.StockSymbol, this.entityData.StockSymbol);
				this.entityData.StockSymbol = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(CashAdvanceColumn.StockSymbol, this.entityData.StockSymbol);
		...
		public virtual System.DateTime? SellDueDate
		{
			...
			set
			{
				...
				OnColumnChanging(CashAdvanceColumn.SellDueDate, this.entityData.SellDueDate);
				this.entityData.SellDueDate = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(CashAdvanceColumn.SellDueDate, this.entityData.SellDueDate);
		...
		public virtual System.DateTime? CashDueDate
		{
			...
			set
			{
				...
				OnColumnChanging(CashAdvanceColumn.CashDueDate, this.entityData.CashDueDate);
				this.entityData.CashDueDate = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(CashAdvanceColumn.CashDueDate, this.entityData.CashDueDate);
		...
		public virtual System.Decimal? TotalSellValue
		{
			...
			set
			{
				...
				OnColumnChanging(CashAdvanceColumn.TotalSellValue, this.entityData.TotalSellValue);
				this.entityData.TotalSellValue = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(CashAdvanceColumn.TotalSellValue, this.entityData.TotalSellValue);
				OnPropertyChanged("TotalSellValue");
			}
		}
		
		/// <summary>
		/// 	Gets or sets the CashAvailable property. 
		///		
		/// </summary>
		/// <value>This type is decimal.</value>
		/// <remarks>
		/// This property can be set to null. 
		/// If this column is null, this property will return 0.0m. It is up to the developer
		/// to check the value of IsCashAvailableNull() and perform business logic appropriately.
		/// </remarks>
		...
		[DescriptionAttribute(@""), System.ComponentModel.Bindable( System.ComponentModel.BindableSupport.Yes)]
		[DataObjectField(false, false, true)]
		public virtual System.Decimal? CashAvailable
		{
			get
			{
				return this.entityData.CashAvailable; 
			}
			
			set
			{
				if (this.entityData.CashAvailable == value)
					return;
					
				OnColumnChanging(CashAdvanceColumn.CashAvailable, this.entityData.CashAvailable);
				this.entityData.CashAvailable = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(CashAdvanceColumn.CashAvailable, this.entityData.CashAvailable);
				OnPropertyChanged("CashAvailable");
			}
		}
		...
		public virtual System.Decimal? CashRequest
		{
			...
			set
			{
				...
				OnColumnChanging(CashAdvanceColumn.CashRequest, this.entityData.CashRequest);
				this.entityData.CashRequest = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(CashAdvanceColumn.CashRequest, this.entityData.CashRequest);
		...
		public virtual System.Decimal? Fee
		{
			...
			set
			{
				...
				OnColumnChanging(CashAdvanceColumn.Fee, this.entityData.Fee);
				this.entityData.Fee = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(CashAdvanceColumn.Fee, this.entityData.Fee);
		...
		public virtual System.Decimal? CashReceived
		{
			...
			set
			{
				...
				OnColumnChanging(CashAdvanceColumn.CashReceived, this.entityData.CashReceived);
				this.entityData.CashReceived = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(CashAdvanceColumn.CashReceived, this.entityData.CashReceived);
		...
		public virtual System.Int32? Status
		{
			...
			set
			{
				...
				OnColumnChanging(CashAdvanceColumn.Status, this.entityData.Status);
				this.entityData.Status = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(CashAdvanceColumn.Status, this.entityData.Status);
		...
		public virtual System.Int32 TradeType
		{
			...
			set
			{
				...
				OnColumnChanging(CashAdvanceColumn.TradeType, this.entityData.TradeType);
				this.entityData.TradeType = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(CashAdvanceColumn.TradeType, this.entityData.TradeType);
		...
		public virtual System.String BrokerId
		{
			...
			set
			{
				...
				OnColumnChanging(CashAdvanceColumn.BrokerId, this.entityData.BrokerId);
				this.entityData.BrokerId = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(CashAdvanceColumn.BrokerId, this.entityData.BrokerId);
		...
		public virtual System.String Reason
		{
			...
			set
			{
				...
				OnColumnChanging(CashAdvanceColumn.Reason, this.entityData.Reason);
				this.entityData.Reason = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(CashAdvanceColumn.Reason, this.entityData.Reason);
		...
		public virtual System.DateTime? ExecTime
		{
			...
			set
			{
				...
				OnColumnChanging(CashAdvanceColumn.ExecTime, this.entityData.ExecTime);
				this.entityData.ExecTime = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(CashAdvanceColumn.ExecTime, this.entityData.ExecTime);
		...
		public virtual System.Decimal? Vat
		{
			...
			set
			{
				...
				OnColumnChanging(CashAdvanceColumn.Vat, this.entityData.Vat);
				this.entityData.Vat = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(CashAdvanceColumn.Vat, this.entityData.Vat);
		...
		public override string[] TableColumns
		{
			get
			{
				return new string[] {"ID", "SubAccountID", "AdvanceDate", "ContractNo", "OrderID", "StockSymbol", "SellDueDate", "CashDueDate", "TotalSellValue", "CashAvailable", "CashRequest", "Fee", "CashReceived", "Status", "TradeType", "BrokerID", "Reason", "ExecTime", "VAT"};
			}
		}
		#endregion 
		...
		void IEditableObject.BeginEdit() 
	    {
	        ...
	        if (!inTxn) 
	        {
	            this.backupData = this.entityData.Clone() as CashAdvanceEntityData;
	            inTxn = true;
	        ...
	        if (this.inTxn) 
	        {
	        	...
	        	//if (this.EntityState == EntityState.Added)
	        	{
					if (this.parentCollection != null)
						this.parentCollection.Remove( (CashAdvance) this ) ;
				}	            
	        }
	    ...
	    public override object ParentCollection
	    {
	        ...
	        set 
	        {
	            this.parentCollection = value as TList<CashAdvance>;
	        }
	    }
	    ...
	    private void OnEntityChanged() 
	    {
	        ...
	        {
	            this.parentCollection.EntityChanged(this as CashAdvance);
	        }
	    }
		...
		///<summary>
		///  Returns a Typed CashAdvance Entity 
		///</summary>
		protected virtual CashAdvance Copy(IDictionary existingCopies)
		{
			...
			//shallow copy entity
			CashAdvance copy = new CashAdvance();
			...
			copy.SuppressEntityEvents = true;
				...
				copy.CashAvailable = this.CashAvailable;
		...
		///  Returns a Typed CashAdvance Entity 
		///</summary>
		public virtual CashAdvance Copy()
		{
		...
		///<summary>
		///  Returns a Typed CashAdvance Entity which is a deep copy of the current entity.
		///</summary>
		public virtual CashAdvance DeepCopy()
		{
			return EntityHelper.Clone<CashAdvance>(this as CashAdvance);	
		}
		#endregion
		...
		public override void CancelChanges()
		{
			...
			{
				this.entityData = this._originalData.Clone() as CashAdvanceEntityData;
			}
			else
			{
		...
		public override void AcceptChanges()
		{
			...
			this._originalData = this.entityData.Clone() as CashAdvanceEntityData;
		}
		...
		{
			return 	IsPropertyChanged(EntityHelper.GetEnumValue< CashAdvanceColumn >(columnName));
		}
		...
		public bool HasDataChanged()
		{
			...
			result = result || entityData.CashAvailable != _originalData.CashAvailable;
		...
		///<summary>
		///  Returns a CashAdvance Entity with the original data.
		///</summary>
		public CashAdvance GetOriginalEntity()
		{
	...
	#region Value Semantics Instance Equality
        ...
        ///<returns>true if Object1 is a <see cref="CashAdvanceBase"/> and has the same value as this instance; otherwise, false.</returns>
        public override bool Equals(object Object1)
        {
			// Cast exception if Object1 is null or DbNull
			if (Object1 != null && Object1 != DBNull.Value && Object1 is CashAdvanceBase)
				return ValueEquals(this, (CashAdvanceBase)Object1);
			else
				return false;
        }
        ...
        /// Provides a hash function that is appropriate for <see cref="CashAdvanceBase"/> class 
        ...
        public override int GetHashCode()
        {
			return this.Id.GetHashCode() ^ 
					...
					((this.CashAvailable == null) ? string.Empty : this.CashAvailable.ToString()).GetHashCode() ^ 
		...
		///<returns>true if toObject is a <see cref="CashAdvanceBase"/> and has the same value as this instance; otherwise, false.</returns>
		public virtual bool Equals(CashAdvanceBase toObject)
		{
			if (toObject == null)
				return false;
		...
		///<summary>
		/// Determines whether the specified <see cref="CashAdvanceBase"/> instances are considered equal using value semantics.
		///</summary>
		///<param name="Object1">The first <see cref="CashAdvanceBase"/> to compare.</param>
		///<param name="Object2">The second <see cref="CashAdvanceBase"/> to compare. </param>
		///<returns>true if Object1 is the same instance as Object2 or if both are null references or if objA.Equals(objB) returns true; otherwise, false.</returns>
		public static bool ValueEquals(CashAdvanceBase Object1, CashAdvanceBase Object2)
		{
			// both are null
			...
			if ( Object1.CashAvailable != null && Object2.CashAvailable != null )
			{
				if (Object1.CashAvailable != Object2.CashAvailable)
					equal = false;
			}
			else if (Object1.CashAvailable == null ^ Object2.CashAvailable == null )
			{
				equal = false;
			}
		...
		public virtual int CompareTo(object obj)
		{
			...
			//return this. GetPropertyName(SourceTable.PrimaryKey.MemberColumns[0]) .CompareTo(((CashAdvanceBase)obj).GetPropertyName(SourceTable.PrimaryKey.MemberColumns[0]));
		}
		
		/*
		// static method to get a Comparer object
        public static CashAdvanceComparer GetComparer()
        {
            return new CashAdvanceComparer();
        }
        */

        // Comparer delegates back to CashAdvance
...
/*
        ...
        public int CompareTo(CashAdvance rhs, CashAdvanceColumn which)
        {
            switch (which)
            {
            	...
            	case CashAdvanceColumn.CashAvailable:
            		return this.CashAvailable.Value.CompareTo(rhs.CashAvailable.Value);
        ...
        */
		...
		#region IEntityKey<CashAdvanceKey> Members
		
		// member variable for the EntityId property
		private CashAdvanceKey _entityId;
		...
		[XmlIgnore]
        [ScriptIgnore]
		public virtual CashAdvanceKey EntityId
		{
			get
			{
				if ( _entityId == null )
				{
					_entityId = new CashAdvanceKey(this);
				}
		...
		public override string EntityTrackingKey
		{
			get
			{
				if(entityTrackingKey == null)
					entityTrackingKey = new System.Text.StringBuilder("CashAdvance")
		...
		public override string ToString()
		{
			return string.Format(System.Globalization.CultureInfo.InvariantCulture,
				"{20}{19}- Id: {0}{19}- SubAccountId: {1}{19}- AdvanceDate: {2}{19}- ContractNo: {3}{19}- OrderId: {4}{19}- StockSymbol: {5}{19}- SellDueDate: {6}{19}- CashDueDate: {7}{19}- TotalSellValue: {8}{19}- CashAvailable: {9}{19}- CashRequest: {10}{19}- Fee: {11}{19}- CashReceived: {12}{19}- Status: {13}{19}- TradeType: {14}{19}- BrokerId: {15}{19}- Reason: {16}{19}- ExecTime: {17}{19}- Vat: {18}{19}{21}", 
				this.Id,
				this.SubAccountId,
				this.AdvanceDate,
				...
				(this.CashAvailable == null) ? string.Empty : this.CashAvailable.ToString(),
	...
	/// <summary>
	///		The data structure representation of the 'CashAdvance' table.
	/// </summary>
	/// <remarks>
	...
	[Serializable]
	internal protected class CashAdvanceEntityData : ICloneable, ICloneableEx
	{
		#region Variable Declarations
		...
		/// CashAvailable : 
		/// </summary>
		public System.Decimal?		  CashAvailable = null;
		...
		public Object Clone()
		{
			CashAdvanceEntityData _tmp = new CashAdvanceEntityData();
			...
			_tmp.CashAvailable = this.CashAvailable;
		...
		/// </summary>
		/// <param name="column">The <see cref="CashAdvanceColumn"/> which has raised the event.</param>
		public virtual void OnColumnChanging(CashAdvanceColumn column)
		{
		...
		/// </summary>
		/// <param name="column">The <see cref="CashAdvanceColumn"/> which has raised the event.</param>
		public virtual void OnColumnChanged(CashAdvanceColumn column)
		{
		...
		public virtual void OnColumnChanging(CashAdvanceColumn column, object value)
		{
			...
			if (!SuppressEntityEvents)
			{
				CashAdvanceEventHandler handler = ColumnChanging;
				if(handler != null)
				{
					handler(this, new CashAdvanceEventArgs(column, value));
				}
			}
		}
		...
		/// <param name="column">The <see cref="CashAdvanceColumn"/> which has raised the event.</param>
		/// <param name="value">The changed value.</param>
		public virtual void OnColumnChanged(CashAdvanceColumn column, object value)
		{
			if (!SuppressEntityEvents)
			{
				CashAdvanceEventHandler handler = ColumnChanged;
				if(handler != null)
				{
					handler(this, new CashAdvanceEventArgs(column, value));
				}
	...
	#region CashAdvanceEventArgs class
	/// <summary>
	/// Provides data for the ColumnChanging and ColumnChanged events.
	/// </summary>
	/// <remarks>
	/// The ColumnChanging and ColumnChanged events occur when a change is made to the value 
	/// of a property of a <see cref="CashAdvance"/> object.
	/// </remarks>
	public class CashAdvanceEventArgs : System.EventArgs
	{
		private CashAdvanceColumn column;
		private object value;
		
		///<summary>
		/// Initalizes a new Instance of the CashAdvanceEventArgs class.
		///</summary>
		public CashAdvanceEventArgs(CashAdvanceColumn column)
		{
			this.column = column;
		}
		...
		/// Initalizes a new Instance of the CashAdvanceEventArgs class.
		///</summary>
		public CashAdvanceEventArgs(CashAdvanceColumn column, object value)
		{
			this.column = column;
			this.value = value;
		}
		...
		///<summary>
		/// The CashAdvanceColumn that was modified, which has raised the event.
		///</summary>
		///<value cref="CashAdvanceColumn" />
		public CashAdvanceColumn Column { get { return this.column; } }
	...
	///<summary>
	/// Define a delegate for all CashAdvance related events.
	///</summary>
	public delegate void CashAdvanceEventHandler(object sender, CashAdvanceEventArgs e);
	
	#region CashAdvanceComparer
		
	/// <summary>
	///	Strongly Typed IComparer
	/// </summary>
	public class CashAdvanceComparer : System.Collections.Generic.IComparer<CashAdvance>
	{
		CashAdvanceColumn whichComparison;
		
		/// <summary>
        /// Initializes a new instance of the <see cref="T:CashAdvanceComparer"/> class.
        /// </summary>
		public CashAdvanceComparer()
        {            
        }               
        ...
        public CashAdvanceComparer(CashAdvanceColumn column)
        {
            this.whichComparison = column;
        }

		/// <summary>
        /// Determines whether the specified <c cref="CashAdvance"/> instances are considered equal.
        /// </summary>
        /// <param name="a">The first <c cref="CashAdvance"/> to compare.</param>
        /// <param name="b">The second <c>CashAdvance</c> to compare.</param>
        /// <returns>true if objA is the same instance as objB or if both are null references or if objA.Equals(objB) returns true; otherwise, false.</returns>
        public bool Equals(CashAdvance a, CashAdvance b)
        {
        ...
        /// <returns></returns>
        public int GetHashCode(CashAdvance entity)
        {
        ...
        /// <returns></returns>
        public int Compare(CashAdvance a, CashAdvance b)
        {
        ...
        public CashAdvanceColumn WhichComparison
        {
	...
	#region CashAdvanceKey Class

	/// <summary>
	/// Wraps the unique identifier values for the <see cref="CashAdvance"/> object.
	/// </summary>
	[Serializable]
	[CLSCompliant(true)]
	public class CashAdvanceKey : EntityKeyBase
	{
		#region Constructors
		
		/// <summary>
		/// Initializes a new instance of the CashAdvanceKey class.
		/// </summary>
		public CashAdvanceKey()
		{
		}
		...
		/// Initializes a new instance of the CashAdvanceKey class.
		/// </summary>
		public CashAdvanceKey(CashAdvanceBase entity)
		{
			this.Entity = entity;
		...
		/// Initializes a new instance of the CashAdvanceKey class.
		/// </summary>
		public CashAdvanceKey(System.Int64 _id)
		{
			#region Init Properties
		...
		private CashAdvanceBase _entity;
		
		/// <summary>
		/// Gets or sets the Entity property.
		/// </summary>
		public CashAdvanceBase Entity
		{
			get { return _entity; }
			set { _entity = value; }
		}
	...
	#region CashAdvanceColumn Enum
	
	/// <summary>
	/// Enumerate the CashAdvance columns.
	/// </summary>
	[Serializable]
	public enum CashAdvanceColumn : int
	{
		/// <summary>
		/// Id : CashAdvanceID identifies CashAdvance
		/// </summary>
		...
		/// CashAvailable : 
		/// </summary>
		[EnumTextValue("CashAvailable")]
		[ColumnEnum("CashAvailable", typeof(System.Decimal), System.Data.DbType.Decimal, false, false, true)]
		CashAvailable = 10,
		/// <summary>
		/// CashRequest : 
		/// </summary>
	...
	#endregion CashAdvanceColumn Enum
