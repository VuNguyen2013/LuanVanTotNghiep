...
namespace ETradeHistory.Entities
{
	...
	public abstract partial class EntityBaseCore : IEntity, INotifyPropertyChanged, IDataErrorInfo, IDeserializationCallback
	{
		...
		public abstract System.DateTime TradeTime {get;set;}
		/// <summary>
		/// 
		/// </summary>
		
		public abstract string SubCustAccountId {get;set;}
		/// <summary>
		/// order id sinh ra tu FIS
		/// </summary>
		
		[XmlElement(IsNullable=true)]
		public abstract System.Int32? FisOrderId {get;set;}
		/// <summary>
		/// Ma chung khoan
		/// </summary>
		
		public abstract string SecSymbol {get;set;}
		/// <summary>
		/// Gia chung khoan
		/// </summary>
		...
		[XmlElement(IsNullable=true)]
		public abstract string RefOrderId {get;set;}
		#endregion		
