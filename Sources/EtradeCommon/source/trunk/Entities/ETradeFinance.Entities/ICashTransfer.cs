...
{
	/// <summary>
	///		The data structure representation of the 'CashTransfer' table via interface.
	/// </summary>
	/// <remarks>
	...
	public interface ICashTransfer 
	{
		...
		/// </summary>
		System.Decimal?  ApprovedAmt  { get; set; }
