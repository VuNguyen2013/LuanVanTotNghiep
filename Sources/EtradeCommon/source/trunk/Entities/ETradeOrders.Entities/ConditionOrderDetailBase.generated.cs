...
namespace ETradeOrders.Entities
{
	...
	{		
		...
		public ConditionOrderDetailBase(System.Int32 _volume, System.Int32 _matchedVolume, 
			System.Int16? _orderStatus, System.Int64 _conditionOrderId, System.Int32? _fisOrderId, 
			System.Int32? _ordRejReason, System.Int32? _numOfMatch, System.Int32? _cancelledVol, 
			System.DateTime _createdDateTime, System.DateTime? _updatedDateTime, System.Decimal? _avgPrice)
		{
			this.entityData = new ConditionOrderDetailEntityData();
			this.backupData = null;
		...
		///<param name="_updatedDateTime">Updated date time</param>
		///<param name="_avgPrice">Average price</param>
		public static ConditionOrderDetail CreateConditionOrderDetail(System.Int32 _volume, System.Int32 _matchedVolume, 
			System.Int16? _orderStatus, System.Int64 _conditionOrderId, System.Int32? _fisOrderId, 
			System.Int32? _ordRejReason, System.Int32? _numOfMatch, System.Int32? _cancelledVol, 
			System.DateTime _createdDateTime, System.DateTime? _updatedDateTime, System.Decimal? _avgPrice)
		{
		...
		public virtual System.Int64 DetailId
		{
			get
			{
		...
		[XmlElement(IsNullable=true)]
		[DescriptionAttribute(@"FIS order id"), System.ComponentModel.Bindable( System.ComponentModel.BindableSupport.Yes)]
		[DataObjectField(false, false, true)]
		...
		[XmlElement(IsNullable=true)]
		[DescriptionAttribute(@"Order reject reason     00: MP order without contra-side     01: Illegal price spread     02: Incorrect volume for specified board     03: Illegal request - Market Closed     04: Incorrect Stock Symbol     05: Incorrect Firm     06: Incorrect Trader ID     07: Incorrect confirm number     08: Too late to perform requested action     09: Incorrect Reference Number     10: Incorrect Conditions     11: Trading halted in Stock     12: Incorrect Board     13: Security in DS - Missing Client ID     14: Incorrect Order Type     15: Incorrect Port / Client flag     16: Incorrect Request Code or Reply Code     17: Incorrect Side: must be Buy or Sell     18: Incorrect Order Number     19: Incorrect Time     20: Incorrect Date     21: Cannot do on Odd-Lot board     22: Incorrect Sub-Broker ID     23: Illegal Trustee ID     24: Security suspended     25: Missing P/C Flag     26: Missing Sub-Broker ID     27: No available room for Thai Trust Fund     28: Market in Intermission     29: Market Halted     30: Incorrect Published Volume     31: Changing Deal information disallowed     32: Publish Vol disallowed at this time     33: Trading disallowed for this stock     34: Incorrect price - above ceiling     35: Incorrect price - below floor     36: Put-Through price incorrect format     37: Cancel of automatch deal disallowed     38: Incorrect Volume for Put-Through deal     39: Incorrect Market Maker     40: Illegal Short Sales Order     41: Illegal Market ID     42: Illegal Message Type/Header     43: Illegal Message Length     71: Warning! Price over 10 %     81: Disapprove Order     82: Reject form FIS     99: Unidentified Error "), System.ComponentModel.Bindable( System.ComponentModel.BindableSupport.Yes)]
		[DataObjectField(false, false, true)]
		...
		[XmlElement(IsNullable=true)]
		[DescriptionAttribute(@"Number of matches"), System.ComponentModel.Bindable( System.ComponentModel.BindableSupport.Yes)]
		[DataObjectField(false, false, true)]
		...
		[XmlElement(IsNullable=true)]
		[DescriptionAttribute(@"Cancelled volume"), System.ComponentModel.Bindable( System.ComponentModel.BindableSupport.Yes)]
		[DataObjectField(false, false, true)]
		...
		public override string[] TableColumns
		{
			get
			{
				return new string[] {"DetailId", "Volume", "MatchedVolume", "OrderStatus", "ConditionOrderID", "FISOrderID", "OrdRejReason", "NumOfMatch", "CancelledVol", "CreatedDateTime", "UpdatedDateTime", "AvgPrice"};
			}
		}
		#endregion 
...
/*
        ...
        */
		...
		public override string ToString()
		{
			return string.Format(System.Globalization.CultureInfo.InvariantCulture,
				"{13}{12}- DetailId: {0}{12}- Volume: {1}{12}- MatchedVolume: {2}{12}- OrderStatus: {3}{12}- ConditionOrderId: {4}{12}- FisOrderId: {5}{12}- OrdRejReason: {6}{12}- NumOfMatch: {7}{12}- CancelledVol: {8}{12}- CreatedDateTime: {9}{12}- UpdatedDateTime: {10}{12}- AvgPrice: {11}{12}{14}", 
				this.DetailId,
				this.Volume,
				this.MatchedVolume,
	...
	internal protected class ConditionOrderDetailEntityData : ICloneable, ICloneableEx
	{
		...
		/// </summary>
		public System.Int64		  ConditionOrderId = (long)0;
	...
	public class ConditionOrderDetailKey : EntityKeyBase
	{
		...
		/// Initializes a new instance of the ConditionOrderDetailKey class.
		/// </summary>
		public ConditionOrderDetailKey(System.Int64 _detailId)
		{
			#region Init Properties
		...
		private System.Int64 _detailId;
		...
		public override void Load(IDictionary values)
		{
			...
			if ( values != null )
			{
				DetailId = ( values["DetailId"] != null ) ? (System.Int64) EntityUtil.ChangeType(values["DetailId"], typeof(System.Int64)) : (long)0;
			}
	...
	public enum ConditionOrderDetailColumn : int
	{
		...
		[ColumnEnum("DetailId", typeof(System.Int64), System.Data.DbType.Int64, true, true, false)]
		DetailId = 1,
		/// <summary>
		/// Volume : Volume putted at that day
		/// </summary>
		...
		[ColumnEnum("ConditionOrderID", typeof(System.Int64), System.Data.DbType.Int64, false, false, false)]
		ConditionOrderId = 5,
		/// <summary>
		/// FisOrderId : FIS order id
		/// </summary>
