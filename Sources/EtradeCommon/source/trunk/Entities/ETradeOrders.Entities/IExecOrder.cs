...
namespace ETradeOrders.Entities
{
	...
	public interface IExecOrder 
	{
		...
		/// </summary>
		System.String  RefOrderId  { get; set; }
		...
		/// </summary>
		System.String  MessageType  { get; set; }
		...
		/// </summary>
		System.String  ConPrice  { get; set; }
		...
		/// </summary>
		System.String  ConfirmNo  { get; set; }
		
		/// <summary>
		/// CancelledConfirmNo : ID cua lenh huy duoc gan boi san giao dich
		/// </summary>
		System.String  CancelledConfirmNo  { get; set; }
		...
		/// </summary>
		System.String  ExecType  { get; set; }
		
		/// <summary>
		/// CancelledExecType : N=normal, C = crossing
		/// </summary>
		System.String  CancelledExecType  { get; set; }
		
		/// <summary>
		/// PortOrClient : Loai khach hang
		/// </summary>
		System.String  PortOrClient  { get; set; }
		...
		/// </summary>
		System.String  MarketStatus  { get; set; }
		
		/// <summary>
		/// OrderSource : Lenh tu web hay tu nguon khac (W = Web,)
		/// </summary>
		System.String  OrderSource  { get; set; }
		...
		/// IsNewStatus : 
		/// </summary>
		System.Boolean?  IsNewStatus  { get; set; }
		
		/// <summary>
		/// IsNewVolume : 
		/// </summary>
		System.Boolean?  IsNewVolume  { get; set; }
		
		/// <summary>
		/// NewPrice : 
		/// </summary>
		System.Decimal?  NewPrice  { get; set; }
		
		/// <summary>
		/// ChangedOrderStatus : 
		/// </summary>
		System.Int16?  ChangedOrderStatus  { get; set; }
