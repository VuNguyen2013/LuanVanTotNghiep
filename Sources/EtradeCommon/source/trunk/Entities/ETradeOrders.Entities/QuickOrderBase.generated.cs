...
namespace ETradeOrders.Entities
{
	...
	{		
		...
		public QuickOrderBase(System.String _secSymbol, System.String _side, System.Int32 _volume, 
			...
			System.String _status, System.String _condition)
		{
			this.entityData = new QuickOrderEntityData();
			this.backupData = null;
			...
			System.String _status, System.String _condition)
		{
			...
			newQuickOrder.Condition = _condition;
		...
		public virtual System.String Condition
		{
			...
			set
			{
				...
				OnColumnChanging(QuickOrderColumn.Condition, this.entityData.Condition);
				this.entityData.Condition = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(QuickOrderColumn.Condition, this.entityData.Condition);
		...
		public override string[] TableColumns
		{
			get
			{
				return new string[] {"QuickOrderID", "SecSymbol", "Side", "Volume", "SubCustAccountID", "Market", "TradeTime", "TypeOfQuick", "Status", "Condition"};
			}
		}
		#endregion 
		...
		public bool IsPropertyChanged(QuickOrderColumn column)
		{
			switch(column)
			{
					...
					case QuickOrderColumn.Condition:
        ...
        */
		...
		public override string ToString()
		{
			return string.Format(System.Globalization.CultureInfo.InvariantCulture,
				"{11}{10}- QuickOrderId: {0}{10}- SecSymbol: {1}{10}- Side: {2}{10}- Volume: {3}{10}- SubCustAccountId: {4}{10}- Market: {5}{10}- TradeTime: {6}{10}- TypeOfQuick: {7}{10}- Status: {8}{10}- Condition: {9}{10}{12}", 
				this.QuickOrderId,
				this.SecSymbol,
				this.Side,
				this.Volume,
