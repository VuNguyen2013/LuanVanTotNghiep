...
{	
	...
	{		
		...
		#region _Indexs_GetLastIndex 
		
		/// <summary>
		///	This method wrap the '_Indexs_GetLastIndex' stored procedure. 
		/// </summary>
		/// <param name="marketId"> A <c>System.Int32?</c> instance.</param>
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="TList&lt;Indexs&gt;"/> instance.</returns>
		public TList<Indexs> GetLastIndex(System.Int32? marketId)
		{
			return GetLastIndex(null, 0, int.MaxValue , marketId);
		}
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="TList&lt;Indexs&gt;"/> instance.</returns>
		public TList<Indexs> GetLastIndex(int start, int pageLength, System.Int32? marketId)
		{
			return GetLastIndex(null, start, pageLength , marketId);
		}
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="TList&lt;Indexs&gt;"/> instance.</returns>
		public TList<Indexs> GetLastIndex(TransactionManager transactionManager, System.Int32? marketId)
		{
			return GetLastIndex(transactionManager, 0, int.MaxValue , marketId);
		}
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="TList&lt;Indexs&gt;"/> instance.</returns>
		public abstract TList<Indexs> GetLastIndex(TransactionManager transactionManager, int start, int pageLength , System.Int32? marketId);
