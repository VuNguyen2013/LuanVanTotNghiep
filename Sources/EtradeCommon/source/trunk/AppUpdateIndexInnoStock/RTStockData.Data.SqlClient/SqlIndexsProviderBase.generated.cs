...
namespace RTStockData.Data.SqlClient
{
    ...
    public string ProviderInvariantName
    {
		...
		/// <summary>
		///	This method wraps the '_Indexs_GetLastIndex' stored procedure. 
		/// </summary>	
		...
		public override TList<Indexs> GetLastIndex(TransactionManager transactionManager, int start, int pageLength , System.Int32? marketId)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo._Indexs_GetLastIndex", true);
			
			database.AddInParameter(commandWrapper, "@MarketId", DbType.Int32,  marketId );
			...
			//Create Collection
				TList<Indexs> rows = new TList<Indexs>();
				//Provider Data Requesting Command Event
				OnDataRequesting(new CommandEventArgs(commandWrapper, "GetLastIndex", rows));
				...
				//Provider Data Requested Command Event
				OnDataRequested(new CommandEventArgs(commandWrapper, "GetLastIndex", rows));
