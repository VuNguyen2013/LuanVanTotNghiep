...
namespace Updater.Repository
{
    public class UpComStockInfoRepository
    {
        ...
        public bool Insert(string content)
        {
            ...
            var listData = _serialization.Deserialize<List<StockCore.Common.UpComStockInfoData>>(content);
            try
            {
                ...
                foreach (var item in listData)
                {
                    ...
                    com.CommandText = "HV_InsertUpComStockInfo";
                    com.Parameters.AddWithValue("@TradeDate",StockCore.Common.CommonFunction.ConvertToSqlDateTime(item.TradeDate));
                    ...
                    com.Parameters.AddWithValue("@SELL_FOREIGN_QTTY", item.SELL_FOREIGN_QTTY);
                    com.Parameters.AddWithValue("@BUY_FOREIGN_QTTY", item.BUY_FOREIGN_QTTY);
                    con.Open();
                    com.ExecuteNonQuery();
                    con.Close();
                }                
