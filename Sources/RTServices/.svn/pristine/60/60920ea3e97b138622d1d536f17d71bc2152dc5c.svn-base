...
/*
	...
	Important: Do not modify this file. Edit the file SqlHastcMarketProvider.cs instead.
*/
...
namespace RTStockData.Data.SqlClient
{
	...
	///</summary>
	public abstract partial class SqlHastcMarketProviderBase : HastcMarketProviderBase
	{
		#region Declarations
		...
		/// <summary>
		/// Creates a new <see cref="SqlHastcMarketProviderBase"/> instance.
		/// </summary>
		public SqlHastcMarketProviderBase()
		{
		}
	...
	public SqlHastcMarketProviderBase(string connectionString, bool useStoredProcedure, string providerInvariantName)
	{
    ...
    public string ProviderInvariantName
    {
		...
		public override bool Delete(TransactionManager transactionManager, System.Int64 _id)
		{
			...
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.hastc_market_Delete", _useStoredProcedure);
			...
			{
				string entityKey = EntityLocator.ConstructKeyFromPkItems(typeof(HastcMarket)
					,_id);
		...
		public override TList<HastcMarket> Find(TransactionManager transactionManager, string whereClause, int start, int pageLength, out int count)
		{
			count = -1;
			if (whereClause.IndexOf(";") > -1)
				return new TList<HastcMarket>();
	
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.hastc_market_Find", _useStoredProcedure);
		...
		database.AddInParameter(commandWrapper, "@SetIndex", DbType.Double, DBNull.Value);
		...
		database.AddInParameter(commandWrapper, "@Advances", DbType.Int16, DBNull.Value);
		database.AddInParameter(commandWrapper, "@Nochange", DbType.Int16, DBNull.Value);
		database.AddInParameter(commandWrapper, "@Declines", DbType.Int16, DBNull.Value);
		database.AddInParameter(commandWrapper, "@Time", DbType.Int64, DBNull.Value);
		database.AddInParameter(commandWrapper, "@OpenIndex", DbType.Double, DBNull.Value);
	   		...
	   		foreach (string clause in clauses)
			{
				...
				if (clause.Trim().StartsWith("openindex ") || clause.Trim().StartsWith("openindex="))
				{
					database.SetParameterValue(commandWrapper, "@OpenIndex", 
						clause.Trim().Remove(0,9).Trim().TrimStart(equalSign).Trim().Trim(singleQuote));
					continue;
				}
			...
			//Create Collection
			TList<HastcMarket> rows = new TList<HastcMarket>();
		...
		/// <param name="count">out. The number of rows that match this query.</param>
		/// <returns>Returns a typed collection of RTStockData.Entities.HastcMarket objects.</returns>
		public override TList<HastcMarket> Find(TransactionManager transactionManager, IFilterParameterCollection parameters, string orderBy, int start, int pageLength, out int count)
		{
			...
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.hastc_market_Find_Dynamic", typeof(HastcMarketColumn), filter, orderBy, start, pageLength);
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override TList<HastcMarket> GetAll(TransactionManager transactionManager, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.hastc_market_Get_List", _useStoredProcedure);
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of RTStockData.Entities.HastcMarket objects.</returns>
		public override TList<HastcMarket> GetPaged(TransactionManager transactionManager, string whereClause, string orderBy, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.hastc_market_GetPaged", _useStoredProcedure);
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override RTStockData.Entities.HastcMarket GetById(TransactionManager transactionManager, System.Int64 _id, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.hastc_market_GetById", _useStoredProcedure);
			
				database.AddInParameter(commandWrapper, "@Id", DbType.Int64, _id);
			
			IDataReader reader = null;
			TList<HastcMarket> tmp = new TList<HastcMarket>();
			try
			{
				//Provider Data Requesting Command Event
		...
		/// </remarks>	
		public override void BulkInsert(TransactionManager transactionManager, TList<RTStockData.Entities.HastcMarket> entities)
		{
			...
			bulkCopy.DestinationTableName = "hastc_market";
			...
			DataColumn col2 = dataTable.Columns.Add("SetIndex", typeof(System.Double));
			...
			DataColumn col6 = dataTable.Columns.Add("Advances", typeof(System.Int16));
			col6.AllowDBNull = true;		
			DataColumn col7 = dataTable.Columns.Add("Nochange", typeof(System.Int16));
			col7.AllowDBNull = true;		
			DataColumn col8 = dataTable.Columns.Add("Declines", typeof(System.Int16));
			col8.AllowDBNull = true;		
			DataColumn col9 = dataTable.Columns.Add("Time", typeof(System.Int64));
			col9.AllowDBNull = true;		
			DataColumn col10 = dataTable.Columns.Add("OpenIndex", typeof(System.Double));
			...
			bulkCopy.ColumnMappings.Add("OpenIndex", "OpenIndex");
			
			foreach(RTStockData.Entities.HastcMarket entity in entities)
			{
				...
				DataRow row = dataTable.NewRow();
					...
					row["OpenIndex"] = entity.OpenIndex.HasValue ? (object) entity.OpenIndex  : System.DBNull.Value;
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override bool Insert(TransactionManager transactionManager, RTStockData.Entities.HastcMarket entity)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.hastc_market_Insert", _useStoredProcedure);
			...
			database.AddInParameter(commandWrapper, "@SetIndex", DbType.Double, (entity.SetIndex.HasValue ? (object) entity.SetIndex  : System.DBNull.Value));
			...
			database.AddInParameter(commandWrapper, "@Advances", DbType.Int16, (entity.Advances.HasValue ? (object) entity.Advances  : System.DBNull.Value));
			database.AddInParameter(commandWrapper, "@Nochange", DbType.Int16, (entity.Nochange.HasValue ? (object) entity.Nochange  : System.DBNull.Value));
			database.AddInParameter(commandWrapper, "@Declines", DbType.Int16, (entity.Declines.HasValue ? (object) entity.Declines  : System.DBNull.Value));
			database.AddInParameter(commandWrapper, "@Time", DbType.Int64, (entity.Time.HasValue ? (object) entity.Time  : System.DBNull.Value));
			database.AddInParameter(commandWrapper, "@OpenIndex", DbType.Double, (entity.OpenIndex.HasValue ? (object) entity.OpenIndex  : System.DBNull.Value));
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override bool Update(TransactionManager transactionManager, RTStockData.Entities.HastcMarket entity)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.hastc_market_Update", _useStoredProcedure);
