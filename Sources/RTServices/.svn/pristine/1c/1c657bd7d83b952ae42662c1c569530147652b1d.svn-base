...
/*
	...
	Important: Do not modify this file. Edit the file IndexInfo.cs instead.
*/
...
namespace RTStockData.Entities
{
	...
	public abstract partial class IndexInfoBase : EntityBase, IIndexInfo, IEntityId<IndexInfoKey>, System.IComparable, System.ICloneable, ICloneableEx, IEditableObject, IComponent, INotifyPropertyChanged
	{		
		...
		/// </summary>
		private IndexInfoEntityData entityData;
		
		/// <summary>
		/// 	Hold the original data of the entity, as loaded from the repository.
		/// </summary>
		private IndexInfoEntityData _originalData;
		
		/// <summary>
		/// 	Hold a backup of the inner data of the entity.
		/// </summary>
		private IndexInfoEntityData backupData; 
		...
		[NonSerialized]
		private TList<IndexInfo> parentCollection;
		...
		/// </summary>
		[field:NonSerialized]
		public event IndexInfoEventHandler ColumnChanging;		
		
		/// <summary>
		/// Occurs after a value has been changed for the specified column.
		/// </summary>
		[field:NonSerialized]
		public event IndexInfoEventHandler ColumnChanged;
		
		#endregion Variable Declarations
		
		#region Constructors
		///<summary>
		/// Creates a new <see cref="IndexInfoBase"/> instance.
		///</summary>
		public IndexInfoBase()
		{
			this.entityData = new IndexInfoEntityData();
		...
		public IndexInfoBase(System.Int64? _indexId, System.String _indexCode, System.String _name, 
			System.String _description, System.DateTime? _tradingDate, System.Int64? _time, System.Decimal? _currentStatus, 
			System.Decimal? _totalStock, System.Decimal? _advances, System.Decimal? _nochange, System.Decimal? _declines, 
			System.Decimal? _totalQtty, System.Decimal? _totalValue, System.Decimal? _priorIndexVal, System.Decimal? _chgIndex, 
			System.Decimal? _pctIndex, System.Decimal? _currentIndex, System.Decimal? _highestIndex, System.Decimal? _lowestIndex, 
			System.Decimal? _sessionNo, System.Decimal? _typeIndex, System.Decimal? _closeIndex, System.DateTime? _tradeDate)
		{
			this.entityData = new IndexInfoEntityData();
			this.backupData = null;
		...
		///<summary>
		/// A simple factory method to create a new <see cref="IndexInfo"/> instance.
		///</summary>
		///<param name="_indexId"></param>
		///<param name="_indexCode"></param>
		///<param name="_name"></param>
		...
		///<param name="_closeIndex"></param>
		///<param name="_tradeDate"></param>
		public static IndexInfo CreateIndexInfo(System.Int64? _indexId, System.String _indexCode, System.String _name, 
			System.String _description, System.DateTime? _tradingDate, System.Int64? _time, System.Decimal? _currentStatus, 
			System.Decimal? _totalStock, System.Decimal? _advances, System.Decimal? _nochange, System.Decimal? _declines, 
			System.Decimal? _totalQtty, System.Decimal? _totalValue, System.Decimal? _priorIndexVal, System.Decimal? _chgIndex, 
			System.Decimal? _pctIndex, System.Decimal? _currentIndex, System.Decimal? _highestIndex, System.Decimal? _lowestIndex, 
			System.Decimal? _sessionNo, System.Decimal? _typeIndex, System.Decimal? _closeIndex, System.DateTime? _tradeDate)
		{
			...
			newIndexInfo.IndexId = _indexId;
			newIndexInfo.IndexCode = _indexCode;
			newIndexInfo.Name = _name;
			newIndexInfo.Description = _description;
			newIndexInfo.TradingDate = _tradingDate;
			newIndexInfo.Time = _time;
			newIndexInfo.CurrentStatus = _currentStatus;
			newIndexInfo.TotalStock = _totalStock;
			newIndexInfo.Advances = _advances;
			newIndexInfo.Nochange = _nochange;
			newIndexInfo.Declines = _declines;
			newIndexInfo.TotalQtty = _totalQtty;
			newIndexInfo.TotalValue = _totalValue;
			newIndexInfo.PriorIndexVal = _priorIndexVal;
			newIndexInfo.ChgIndex = _chgIndex;
			newIndexInfo.PctIndex = _pctIndex;
			newIndexInfo.CurrentIndex = _currentIndex;
			newIndexInfo.HighestIndex = _highestIndex;
			newIndexInfo.LowestIndex = _lowestIndex;
			newIndexInfo.SessionNo = _sessionNo;
			newIndexInfo.TypeIndex = _typeIndex;
			newIndexInfo.CloseIndex = _closeIndex;
			newIndexInfo.TradeDate = _tradeDate;
			return newIndexInfo;
		}
		...
		public virtual System.Int64 Id
		{
			...
			set
			{
				...
				OnColumnChanging(IndexInfoColumn.Id, this.entityData.Id);
				this.entityData.Id = value;
				this.EntityId.Id = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(IndexInfoColumn.Id, this.entityData.Id);
		...
		public virtual System.Int64? IndexId
		{
			...
			set
			{
				...
				OnColumnChanging(IndexInfoColumn.IndexId, this.entityData.IndexId);
				this.entityData.IndexId = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(IndexInfoColumn.IndexId, this.entityData.IndexId);
		...
		public virtual System.String IndexCode
		{
			...
			set
			{
				...
				OnColumnChanging(IndexInfoColumn.IndexCode, this.entityData.IndexCode);
				this.entityData.IndexCode = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(IndexInfoColumn.IndexCode, this.entityData.IndexCode);
		...
		public virtual System.String Name
		{
			...
			set
			{
				...
				OnColumnChanging(IndexInfoColumn.Name, this.entityData.Name);
				this.entityData.Name = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(IndexInfoColumn.Name, this.entityData.Name);
		...
		public virtual System.String Description
		{
			...
			set
			{
				...
				OnColumnChanging(IndexInfoColumn.Description, this.entityData.Description);
				this.entityData.Description = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(IndexInfoColumn.Description, this.entityData.Description);
		...
		public virtual System.DateTime? TradingDate
		{
			...
			set
			{
				...
				OnColumnChanging(IndexInfoColumn.TradingDate, this.entityData.TradingDate);
				this.entityData.TradingDate = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(IndexInfoColumn.TradingDate, this.entityData.TradingDate);
		...
		public virtual System.Int64? Time
		{
			...
			set
			{
				...
				OnColumnChanging(IndexInfoColumn.Time, this.entityData.Time);
				this.entityData.Time = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(IndexInfoColumn.Time, this.entityData.Time);
		...
		public virtual System.Decimal? CurrentStatus
		{
			...
			set
			{
				...
				OnColumnChanging(IndexInfoColumn.CurrentStatus, this.entityData.CurrentStatus);
				this.entityData.CurrentStatus = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(IndexInfoColumn.CurrentStatus, this.entityData.CurrentStatus);
		...
		public virtual System.Decimal? TotalStock
		{
			...
			set
			{
				...
				OnColumnChanging(IndexInfoColumn.TotalStock, this.entityData.TotalStock);
				this.entityData.TotalStock = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(IndexInfoColumn.TotalStock, this.entityData.TotalStock);
		...
		public virtual System.Decimal? Advances
		{
			...
			set
			{
				...
				OnColumnChanging(IndexInfoColumn.Advances, this.entityData.Advances);
				this.entityData.Advances = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(IndexInfoColumn.Advances, this.entityData.Advances);
		...
		public virtual System.Decimal? Nochange
		{
			...
			set
			{
				...
				OnColumnChanging(IndexInfoColumn.Nochange, this.entityData.Nochange);
				this.entityData.Nochange = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(IndexInfoColumn.Nochange, this.entityData.Nochange);
		...
		public virtual System.Decimal? Declines
		{
			...
			set
			{
				...
				OnColumnChanging(IndexInfoColumn.Declines, this.entityData.Declines);
				this.entityData.Declines = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(IndexInfoColumn.Declines, this.entityData.Declines);
		...
		public virtual System.Decimal? TotalQtty
		{
			...
			set
			{
				...
				OnColumnChanging(IndexInfoColumn.TotalQtty, this.entityData.TotalQtty);
				this.entityData.TotalQtty = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(IndexInfoColumn.TotalQtty, this.entityData.TotalQtty);
		...
		public virtual System.Decimal? TotalValue
		{
			...
			set
			{
				...
				OnColumnChanging(IndexInfoColumn.TotalValue, this.entityData.TotalValue);
				this.entityData.TotalValue = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(IndexInfoColumn.TotalValue, this.entityData.TotalValue);
		...
		public virtual System.Decimal? PriorIndexVal
		{
			...
			set
			{
				...
				OnColumnChanging(IndexInfoColumn.PriorIndexVal, this.entityData.PriorIndexVal);
				this.entityData.PriorIndexVal = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(IndexInfoColumn.PriorIndexVal, this.entityData.PriorIndexVal);
		...
		public virtual System.Decimal? ChgIndex
		{
			...
			set
			{
				...
				OnColumnChanging(IndexInfoColumn.ChgIndex, this.entityData.ChgIndex);
				this.entityData.ChgIndex = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(IndexInfoColumn.ChgIndex, this.entityData.ChgIndex);
		...
		public virtual System.Decimal? PctIndex
		{
			...
			set
			{
				...
				OnColumnChanging(IndexInfoColumn.PctIndex, this.entityData.PctIndex);
				this.entityData.PctIndex = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(IndexInfoColumn.PctIndex, this.entityData.PctIndex);
		...
		public virtual System.Decimal? CurrentIndex
		{
			...
			set
			{
				...
				OnColumnChanging(IndexInfoColumn.CurrentIndex, this.entityData.CurrentIndex);
				this.entityData.CurrentIndex = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(IndexInfoColumn.CurrentIndex, this.entityData.CurrentIndex);
		...
		public virtual System.Decimal? HighestIndex
		{
			...
			set
			{
				...
				OnColumnChanging(IndexInfoColumn.HighestIndex, this.entityData.HighestIndex);
				this.entityData.HighestIndex = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(IndexInfoColumn.HighestIndex, this.entityData.HighestIndex);
		...
		public virtual System.Decimal? LowestIndex
		{
			...
			set
			{
				...
				OnColumnChanging(IndexInfoColumn.LowestIndex, this.entityData.LowestIndex);
				this.entityData.LowestIndex = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(IndexInfoColumn.LowestIndex, this.entityData.LowestIndex);
		...
		public virtual System.Decimal? SessionNo
		{
			...
			set
			{
				...
				OnColumnChanging(IndexInfoColumn.SessionNo, this.entityData.SessionNo);
				this.entityData.SessionNo = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(IndexInfoColumn.SessionNo, this.entityData.SessionNo);
		...
		public virtual System.Decimal? TypeIndex
		{
			...
			set
			{
				...
				OnColumnChanging(IndexInfoColumn.TypeIndex, this.entityData.TypeIndex);
				this.entityData.TypeIndex = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(IndexInfoColumn.TypeIndex, this.entityData.TypeIndex);
		...
		public virtual System.Decimal? CloseIndex
		{
			...
			set
			{
				...
				OnColumnChanging(IndexInfoColumn.CloseIndex, this.entityData.CloseIndex);
				this.entityData.CloseIndex = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(IndexInfoColumn.CloseIndex, this.entityData.CloseIndex);
		...
		public virtual System.DateTime? TradeDate
		{
			...
			set
			{
				...
				OnColumnChanging(IndexInfoColumn.TradeDate, this.entityData.TradeDate);
				this.entityData.TradeDate = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(IndexInfoColumn.TradeDate, this.entityData.TradeDate);
		...
		void IEditableObject.BeginEdit() 
	    {
	        ...
	        if (!inTxn) 
	        {
	            this.backupData = this.entityData.Clone() as IndexInfoEntityData;
	            inTxn = true;
	        ...
	        if (this.inTxn) 
	        {
	        	...
	        	//if (this.EntityState == EntityState.Added)
	        	{
					if (this.parentCollection != null)
						this.parentCollection.Remove( (IndexInfo) this ) ;
				}	            
	        }
	    ...
	    public override object ParentCollection
	    {
	        ...
	        set 
	        {
	            this.parentCollection = value as TList<IndexInfo>;
	        }
	    }
	    ...
	    private void OnEntityChanged() 
	    {
	        ...
	        {
	            this.parentCollection.EntityChanged(this as IndexInfo);
	        }
	    }
		...
		///<summary>
		///  Returns a Typed IndexInfo Entity 
		///</summary>
		protected virtual IndexInfo Copy(IDictionary existingCopies)
		{
		...
		///<summary>
		///  Returns a Typed IndexInfo Entity which is a deep copy of the current entity.
		///</summary>
		public virtual IndexInfo DeepCopy()
		{
			return EntityHelper.Clone<IndexInfo>(this as IndexInfo);	
		}
		#endregion
		...
		public override void CancelChanges()
		{
			...
			{
				this.entityData = this._originalData.Clone() as IndexInfoEntityData;
			}
			else
			{
		...
		public override void AcceptChanges()
		{
			...
			this._originalData = this.entityData.Clone() as IndexInfoEntityData;
		}
		...
		{
			return 	IsPropertyChanged(EntityHelper.GetEnumValue< IndexInfoColumn >(columnName));
		}
		...
		///<summary>
		///  Returns a IndexInfo Entity with the original data.
		///</summary>
		public IndexInfo GetOriginalEntity()
		{
	...
	#region Value Semantics Instance Equality
        ...
        ///<returns>true if Object1 is a <see cref="IndexInfoBase"/> and has the same value as this instance; otherwise, false.</returns>
        public override bool Equals(object Object1)
        {
			// Cast exception if Object1 is null or DbNull
			if (Object1 != null && Object1 != DBNull.Value && Object1 is IndexInfoBase)
				return ValueEquals(this, (IndexInfoBase)Object1);
			else
				return false;
        }
        ...
        /// Provides a hash function that is appropriate for <see cref="IndexInfoBase"/> class 
		...
		///<returns>true if toObject is a <see cref="IndexInfoBase"/> and has the same value as this instance; otherwise, false.</returns>
		public virtual bool Equals(IndexInfoBase toObject)
		{
			if (toObject == null)
				return false;
		...
		///<summary>
		/// Determines whether the specified <see cref="IndexInfoBase"/> instances are considered equal using value semantics.
		///</summary>
		///<param name="Object1">The first <see cref="IndexInfoBase"/> to compare.</param>
		///<param name="Object2">The second <see cref="IndexInfoBase"/> to compare. </param>
		///<returns>true if Object1 is the same instance as Object2 or if both are null references or if objA.Equals(objB) returns true; otherwise, false.</returns>
		public static bool ValueEquals(IndexInfoBase Object1, IndexInfoBase Object2)
		{
			// both are null
		...
		public virtual int CompareTo(object obj)
		{
			...
			//return this. GetPropertyName(SourceTable.PrimaryKey.MemberColumns[0]) .CompareTo(((IndexInfoBase)obj).GetPropertyName(SourceTable.PrimaryKey.MemberColumns[0]));
		}
		
		/*
		// static method to get a Comparer object
        public static IndexInfoComparer GetComparer()
        {
            return new IndexInfoComparer();
        }
        */

        // Comparer delegates back to IndexInfo
...
/*
        ...
        public int CompareTo(IndexInfo rhs, IndexInfoColumn which)
        {
            switch (which)
            {
        ...
        */
		...
		#region IEntityKey<IndexInfoKey> Members
		
		// member variable for the EntityId property
		private IndexInfoKey _entityId;
		...
		[XmlIgnore]
        [ScriptIgnore]
		public virtual IndexInfoKey EntityId
		{
			get
			{
				if ( _entityId == null )
				{
					_entityId = new IndexInfoKey(this);
				}
		...
		public override string EntityTrackingKey
		{
			get
			{
				if(entityTrackingKey == null)
					entityTrackingKey = new System.Text.StringBuilder("IndexInfo")
	...
	/// <summary>
	///		The data structure representation of the 'IndexInfo' table.
	/// </summary>
	/// <remarks>
	...
	[Serializable]
	internal protected class IndexInfoEntityData : ICloneable, ICloneableEx
	{
		#region Variable Declarations
		...
		/// ID : 
		/// </summary>
		/// <remarks>Member of the primary key of the underlying table "IndexInfo"</remarks>
		...
		public Object Clone()
		{
			IndexInfoEntityData _tmp = new IndexInfoEntityData();
		...
		/// </summary>
		/// <param name="column">The <see cref="IndexInfoColumn"/> which has raised the event.</param>
		public virtual void OnColumnChanging(IndexInfoColumn column)
		{
		...
		/// </summary>
		/// <param name="column">The <see cref="IndexInfoColumn"/> which has raised the event.</param>
		public virtual void OnColumnChanged(IndexInfoColumn column)
		{
		...
		public virtual void OnColumnChanging(IndexInfoColumn column, object value)
		{
			...
			if (!SuppressEntityEvents)
			{
				IndexInfoEventHandler handler = ColumnChanging;
				if(handler != null)
				{
					handler(this, new IndexInfoEventArgs(column, value));
				}
			}
		}
		...
		/// <param name="column">The <see cref="IndexInfoColumn"/> which has raised the event.</param>
		/// <param name="value">The changed value.</param>
		public virtual void OnColumnChanged(IndexInfoColumn column, object value)
		{
			if (!SuppressEntityEvents)
			{
				IndexInfoEventHandler handler = ColumnChanged;
				if(handler != null)
				{
					handler(this, new IndexInfoEventArgs(column, value));
				}
	...
	#region IndexInfoEventArgs class
	/// <summary>
	/// Provides data for the ColumnChanging and ColumnChanged events.
	/// </summary>
	/// <remarks>
	/// The ColumnChanging and ColumnChanged events occur when a change is made to the value 
	/// of a property of a <see cref="IndexInfo"/> object.
	/// </remarks>
	public class IndexInfoEventArgs : System.EventArgs
	{
		private IndexInfoColumn column;
		private object value;
		
		///<summary>
		/// Initalizes a new Instance of the IndexInfoEventArgs class.
		///</summary>
		public IndexInfoEventArgs(IndexInfoColumn column)
		{
			this.column = column;
		}
		...
		/// Initalizes a new Instance of the IndexInfoEventArgs class.
		///</summary>
		public IndexInfoEventArgs(IndexInfoColumn column, object value)
		{
			this.column = column;
			this.value = value;
		}
		...
		///<summary>
		/// The IndexInfoColumn that was modified, which has raised the event.
		///</summary>
		///<value cref="IndexInfoColumn" />
		public IndexInfoColumn Column { get { return this.column; } }
	...
	///<summary>
	/// Define a delegate for all IndexInfo related events.
	///</summary>
	public delegate void IndexInfoEventHandler(object sender, IndexInfoEventArgs e);
	
	#region IndexInfoComparer
		
	/// <summary>
	///	Strongly Typed IComparer
	/// </summary>
	public class IndexInfoComparer : System.Collections.Generic.IComparer<IndexInfo>
	{
		IndexInfoColumn whichComparison;
		
		/// <summary>
        /// Initializes a new instance of the <see cref="T:IndexInfoComparer"/> class.
        /// </summary>
		public IndexInfoComparer()
        {            
        }               
        ...
        public IndexInfoComparer(IndexInfoColumn column)
        {
            this.whichComparison = column;
        }

		/// <summary>
        /// Determines whether the specified <c cref="IndexInfo"/> instances are considered equal.
        /// </summary>
        /// <param name="a">The first <c cref="IndexInfo"/> to compare.</param>
        /// <param name="b">The second <c>IndexInfo</c> to compare.</param>
        /// <returns>true if objA is the same instance as objB or if both are null references or if objA.Equals(objB) returns true; otherwise, false.</returns>
        public bool Equals(IndexInfo a, IndexInfo b)
        {
        ...
        /// <returns></returns>
        public int GetHashCode(IndexInfo entity)
        {
        ...
        /// <returns></returns>
        public int Compare(IndexInfo a, IndexInfo b)
        {
        ...
        public IndexInfoColumn WhichComparison
        {
	...
	#region IndexInfoKey Class

	/// <summary>
	/// Wraps the unique identifier values for the <see cref="IndexInfo"/> object.
	/// </summary>
	[Serializable]
	[CLSCompliant(true)]
	public class IndexInfoKey : EntityKeyBase
	{
		#region Constructors
		
		/// <summary>
		/// Initializes a new instance of the IndexInfoKey class.
		/// </summary>
		public IndexInfoKey()
		{
		}
		...
		/// Initializes a new instance of the IndexInfoKey class.
		/// </summary>
		public IndexInfoKey(IndexInfoBase entity)
		{
			this.Entity = entity;
		...
		/// Initializes a new instance of the IndexInfoKey class.
		/// </summary>
		public IndexInfoKey(System.Int64 _id)
		{
			#region Init Properties
		...
		private IndexInfoBase _entity;
		
		/// <summary>
		/// Gets or sets the Entity property.
		/// </summary>
		public IndexInfoBase Entity
		{
			get { return _entity; }
			set { _entity = value; }
		}
	...
	#region IndexInfoColumn Enum
	
	/// <summary>
	/// Enumerate the IndexInfo columns.
	/// </summary>
	[Serializable]
	public enum IndexInfoColumn : int
	{
		/// <summary>
		/// Id : 
		/// </summary>
	...
	#endregion IndexInfoColumn Enum
