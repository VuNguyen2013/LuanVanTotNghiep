...
{
	///<summary>
	/// An object representation of the 'upcom_transactions' table. [No description found the database]	
	///</summary>
	[Serializable]
	[DataObject, CLSCompliant(true)]
	public abstract partial class UpcomTransactionsBase : EntityBase, IUpcomTransactions, IEntityId<UpcomTransactionsKey>, System.IComparable, System.ICloneable, ICloneableEx, IEditableObject, IComponent, INotifyPropertyChanged
	{		
		...
		/// </summary>
		private UpcomTransactionsEntityData entityData;
		
		/// <summary>
		/// 	Hold the original data of the entity, as loaded from the repository.
		/// </summary>
		private UpcomTransactionsEntityData _originalData;
		
		/// <summary>
		/// 	Hold a backup of the inner data of the entity.
		/// </summary>
		private UpcomTransactionsEntityData backupData; 
		...
		[NonSerialized]
		private TList<UpcomTransactions> parentCollection;
		...
		/// </summary>
		[field:NonSerialized]
		public event UpcomTransactionsEventHandler ColumnChanging;		
		
		/// <summary>
		/// Occurs after a value has been changed for the specified column.
		/// </summary>
		[field:NonSerialized]
		public event UpcomTransactionsEventHandler ColumnChanged;
		
		#endregion Variable Declarations
		
		#region Constructors
		///<summary>
		/// Creates a new <see cref="UpcomTransactionsBase"/> instance.
		///</summary>
		public UpcomTransactionsBase()
		{
			this.entityData = new UpcomTransactionsEntityData();
		...
		public UpcomTransactionsBase(System.DateTime? _tradeDate, System.String _stockSymbol, 
		...
		///<param name="_time"></param>
		///<param name="_side"></param>
		public static UpcomTransactions CreateUpcomTransactions(System.DateTime? _tradeDate, System.String _stockSymbol, 
			System.Int32? _price, System.Int32? _vol, System.Int64? _val, System.Int32? _accumulatedVol, 
			System.Int64? _accumulatedVal, System.Int32? _highest, System.Int32? _lowest, 
			System.Int32? _time, System.String _side)
		{
			UpcomTransactions newUpcomTransactions = new UpcomTransactions();
			newUpcomTransactions.TradeDate = _tradeDate;
			newUpcomTransactions.StockSymbol = _stockSymbol;
			newUpcomTransactions.Price = _price;
			newUpcomTransactions.Vol = _vol;
			newUpcomTransactions.Val = _val;
			newUpcomTransactions.AccumulatedVol = _accumulatedVol;
			newUpcomTransactions.AccumulatedVal = _accumulatedVal;
			newUpcomTransactions.Highest = _highest;
			newUpcomTransactions.Lowest = _lowest;
			newUpcomTransactions.Time = _time;
			newUpcomTransactions.Side = _side;
			return newUpcomTransactions;
		}
		...
		public virtual System.Int64 Id
		{
			...
			set
			{
				...
				OnColumnChanging(UpcomTransactionsColumn.Id, this.entityData.Id);
				this.entityData.Id = value;
				this.EntityId.Id = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(UpcomTransactionsColumn.Id, this.entityData.Id);
		...
		public virtual System.DateTime? TradeDate
		{
			...
			set
			{
				...
				OnColumnChanging(UpcomTransactionsColumn.TradeDate, this.entityData.TradeDate);
				this.entityData.TradeDate = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(UpcomTransactionsColumn.TradeDate, this.entityData.TradeDate);
		...
		public virtual System.String StockSymbol
		{
			...
			set
			{
				...
				OnColumnChanging(UpcomTransactionsColumn.StockSymbol, this.entityData.StockSymbol);
				this.entityData.StockSymbol = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(UpcomTransactionsColumn.StockSymbol, this.entityData.StockSymbol);
		...
		public virtual System.Int32? Price
		{
			...
			set
			{
				...
				OnColumnChanging(UpcomTransactionsColumn.Price, this.entityData.Price);
				this.entityData.Price = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(UpcomTransactionsColumn.Price, this.entityData.Price);
		...
		public virtual System.Int32? Vol
		{
			...
			set
			{
				...
				OnColumnChanging(UpcomTransactionsColumn.Vol, this.entityData.Vol);
				this.entityData.Vol = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(UpcomTransactionsColumn.Vol, this.entityData.Vol);
		...
		public virtual System.Int64? Val
		{
			...
			set
			{
				...
				OnColumnChanging(UpcomTransactionsColumn.Val, this.entityData.Val);
				this.entityData.Val = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(UpcomTransactionsColumn.Val, this.entityData.Val);
		...
		public virtual System.Int32? AccumulatedVol
		{
			...
			set
			{
				...
				OnColumnChanging(UpcomTransactionsColumn.AccumulatedVol, this.entityData.AccumulatedVol);
				this.entityData.AccumulatedVol = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(UpcomTransactionsColumn.AccumulatedVol, this.entityData.AccumulatedVol);
		...
		public virtual System.Int64? AccumulatedVal
		{
			...
			set
			{
				...
				OnColumnChanging(UpcomTransactionsColumn.AccumulatedVal, this.entityData.AccumulatedVal);
				this.entityData.AccumulatedVal = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(UpcomTransactionsColumn.AccumulatedVal, this.entityData.AccumulatedVal);
		...
		public virtual System.Int32? Highest
		{
			...
			set
			{
				...
				OnColumnChanging(UpcomTransactionsColumn.Highest, this.entityData.Highest);
				this.entityData.Highest = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(UpcomTransactionsColumn.Highest, this.entityData.Highest);
		...
		public virtual System.Int32? Lowest
		{
			...
			set
			{
				...
				OnColumnChanging(UpcomTransactionsColumn.Lowest, this.entityData.Lowest);
				this.entityData.Lowest = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(UpcomTransactionsColumn.Lowest, this.entityData.Lowest);
		...
		public virtual System.Int32? Time
		{
			...
			set
			{
				...
				OnColumnChanging(UpcomTransactionsColumn.Time, this.entityData.Time);
				this.entityData.Time = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(UpcomTransactionsColumn.Time, this.entityData.Time);
		...
		public virtual System.String Side
		{
			...
			set
			{
				...
				OnColumnChanging(UpcomTransactionsColumn.Side, this.entityData.Side);
				this.entityData.Side = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(UpcomTransactionsColumn.Side, this.entityData.Side);
		...
		void IEditableObject.BeginEdit() 
	    {
	        ...
	        if (!inTxn) 
	        {
	            this.backupData = this.entityData.Clone() as UpcomTransactionsEntityData;
	            inTxn = true;
	        ...
	        if (this.inTxn) 
	        {
	        	...
	        	//if (this.EntityState == EntityState.Added)
	        	{
					if (this.parentCollection != null)
						this.parentCollection.Remove( (UpcomTransactions) this ) ;
				}	            
	        }
	    ...
	    public override object ParentCollection
	    {
	        ...
	        set 
	        {
	            this.parentCollection = value as TList<UpcomTransactions>;
	        }
	    }
	    ...
	    private void OnEntityChanged() 
	    {
	        ...
	        {
	            this.parentCollection.EntityChanged(this as UpcomTransactions);
	        }
	    }
		...
		///<summary>
		///  Returns a Typed UpcomTransactions Entity 
		///</summary>
		protected virtual UpcomTransactions Copy(IDictionary existingCopies)
		{
			...
			//shallow copy entity
			UpcomTransactions copy = new UpcomTransactions();
		...
		///  Returns a Typed UpcomTransactions Entity 
		///</summary>
		public virtual UpcomTransactions Copy()
		{
		...
		///<summary>
		///  Returns a Typed UpcomTransactions Entity which is a deep copy of the current entity.
		///</summary>
		public virtual UpcomTransactions DeepCopy()
		{
			return EntityHelper.Clone<UpcomTransactions>(this as UpcomTransactions);	
		}
		#endregion
		...
		public override void CancelChanges()
		{
			...
			{
				this.entityData = this._originalData.Clone() as UpcomTransactionsEntityData;
			}
			else
			{
		...
		public override void AcceptChanges()
		{
			...
			this._originalData = this.entityData.Clone() as UpcomTransactionsEntityData;
		}
		...
		/// </returns>
		public bool IsPropertyChanged(UpcomTransactionsColumn column)
		{
			switch(column)
			{
					case UpcomTransactionsColumn.Id:
					return entityData.Id != _originalData.Id;
					case UpcomTransactionsColumn.TradeDate:
					return entityData.TradeDate != _originalData.TradeDate;
					case UpcomTransactionsColumn.StockSymbol:
					return entityData.StockSymbol != _originalData.StockSymbol;
					case UpcomTransactionsColumn.Price:
					return entityData.Price != _originalData.Price;
					case UpcomTransactionsColumn.Vol:
					return entityData.Vol != _originalData.Vol;
					case UpcomTransactionsColumn.Val:
					return entityData.Val != _originalData.Val;
					case UpcomTransactionsColumn.AccumulatedVol:
					return entityData.AccumulatedVol != _originalData.AccumulatedVol;
					case UpcomTransactionsColumn.AccumulatedVal:
					return entityData.AccumulatedVal != _originalData.AccumulatedVal;
					case UpcomTransactionsColumn.Highest:
					return entityData.Highest != _originalData.Highest;
					case UpcomTransactionsColumn.Lowest:
					return entityData.Lowest != _originalData.Lowest;
					case UpcomTransactionsColumn.Time:
					return entityData.Time != _originalData.Time;
					case UpcomTransactionsColumn.Side:
		...
		{
			return 	IsPropertyChanged(EntityHelper.GetEnumValue< UpcomTransactionsColumn >(columnName));
		}
		...
		///<summary>
		///  Returns a UpcomTransactions Entity with the original data.
		///</summary>
		public UpcomTransactions GetOriginalEntity()
		{
			if (_originalData != null)
				return CreateUpcomTransactions(
			...
			return (UpcomTransactions)this.Clone();
		}
		#endregion
	...
	#region Value Semantics Instance Equality
        ...
        ///<returns>true if Object1 is a <see cref="UpcomTransactionsBase"/> and has the same value as this instance; otherwise, false.</returns>
        public override bool Equals(object Object1)
        {
			// Cast exception if Object1 is null or DbNull
			if (Object1 != null && Object1 != DBNull.Value && Object1 is UpcomTransactionsBase)
				return ValueEquals(this, (UpcomTransactionsBase)Object1);
			else
				return false;
        }
        ...
        /// Provides a hash function that is appropriate for <see cref="UpcomTransactionsBase"/> class 
		...
		///<returns>true if toObject is a <see cref="UpcomTransactionsBase"/> and has the same value as this instance; otherwise, false.</returns>
		public virtual bool Equals(UpcomTransactionsBase toObject)
		{
			if (toObject == null)
				return false;
		...
		///<summary>
		/// Determines whether the specified <see cref="UpcomTransactionsBase"/> instances are considered equal using value semantics.
		///</summary>
		///<param name="Object1">The first <see cref="UpcomTransactionsBase"/> to compare.</param>
		///<param name="Object2">The second <see cref="UpcomTransactionsBase"/> to compare. </param>
		///<returns>true if Object1 is the same instance as Object2 or if both are null references or if objA.Equals(objB) returns true; otherwise, false.</returns>
		public static bool ValueEquals(UpcomTransactionsBase Object1, UpcomTransactionsBase Object2)
		{
			// both are null
		...
		public virtual int CompareTo(object obj)
		{
			...
			//return this. GetPropertyName(SourceTable.PrimaryKey.MemberColumns[0]) .CompareTo(((UpcomTransactionsBase)obj).GetPropertyName(SourceTable.PrimaryKey.MemberColumns[0]));
		}
		
		/*
		// static method to get a Comparer object
        public static UpcomTransactionsComparer GetComparer()
        {
            return new UpcomTransactionsComparer();
        }
        */

        // Comparer delegates back to UpcomTransactions
...
/*
        ...
        public int CompareTo(UpcomTransactions rhs, UpcomTransactionsColumn which)
        {
            switch (which)
            {
        ...
        */
		...
		#region IEntityKey<UpcomTransactionsKey> Members
		
		// member variable for the EntityId property
		private UpcomTransactionsKey _entityId;

		/// <summary>
		/// Gets or sets the EntityId property.
		/// </summary>
		[XmlIgnore]
		public virtual UpcomTransactionsKey EntityId
		{
			get
			{
				if ( _entityId == null )
				{
					_entityId = new UpcomTransactionsKey(this);
				}
		...
		public override string EntityTrackingKey
		{
			get
			{
				if(entityTrackingKey == null)
					entityTrackingKey = new System.Text.StringBuilder("UpcomTransactions")
	...
	/// <summary>
	///		The data structure representation of the 'upcom_transactions' table.
	/// </summary>
	/// <remarks>
	...
	[Serializable]
	internal protected class UpcomTransactionsEntityData : ICloneable, ICloneableEx
	{
		#region Variable Declarations
		...
		/// id : 
		/// </summary>
		/// <remarks>Member of the primary key of the underlying table "upcom_transactions"</remarks>
		...
		public Object Clone()
		{
			UpcomTransactionsEntityData _tmp = new UpcomTransactionsEntityData();
		...
		/// </summary>
		/// <param name="column">The <see cref="UpcomTransactionsColumn"/> which has raised the event.</param>
		public virtual void OnColumnChanging(UpcomTransactionsColumn column)
		{
		...
		/// </summary>
		/// <param name="column">The <see cref="UpcomTransactionsColumn"/> which has raised the event.</param>
		public virtual void OnColumnChanged(UpcomTransactionsColumn column)
		{
		...
		public virtual void OnColumnChanging(UpcomTransactionsColumn column, object value)
		{
			...
			if (!SuppressEntityEvents)
			{
				UpcomTransactionsEventHandler handler = ColumnChanging;
				if(handler != null)
				{
					handler(this, new UpcomTransactionsEventArgs(column, value));
				}
			}
		}
		...
		/// <param name="column">The <see cref="UpcomTransactionsColumn"/> which has raised the event.</param>
		/// <param name="value">The changed value.</param>
		public virtual void OnColumnChanged(UpcomTransactionsColumn column, object value)
		{
			if (!SuppressEntityEvents)
			{
				UpcomTransactionsEventHandler handler = ColumnChanged;
				if(handler != null)
				{
					handler(this, new UpcomTransactionsEventArgs(column, value));
				}
	...
	#region UpcomTransactionsEventArgs class
	/// <summary>
	/// Provides data for the ColumnChanging and ColumnChanged events.
	/// </summary>
	/// <remarks>
	/// The ColumnChanging and ColumnChanged events occur when a change is made to the value 
	/// of a property of a <see cref="UpcomTransactions"/> object.
	/// </remarks>
	public class UpcomTransactionsEventArgs : System.EventArgs
	{
		private UpcomTransactionsColumn column;
		private object value;
		
		///<summary>
		/// Initalizes a new Instance of the UpcomTransactionsEventArgs class.
		///</summary>
		public UpcomTransactionsEventArgs(UpcomTransactionsColumn column)
		{
			this.column = column;
		}
		...
		/// Initalizes a new Instance of the UpcomTransactionsEventArgs class.
		///</summary>
		public UpcomTransactionsEventArgs(UpcomTransactionsColumn column, object value)
		{
			this.column = column;
			this.value = value;
		}
		...
		///<summary>
		/// The UpcomTransactionsColumn that was modified, which has raised the event.
		///</summary>
		///<value cref="UpcomTransactionsColumn" />
		public UpcomTransactionsColumn Column { get { return this.column; } }
	...
	///<summary>
	/// Define a delegate for all UpcomTransactions related events.
	///</summary>
	public delegate void UpcomTransactionsEventHandler(object sender, UpcomTransactionsEventArgs e);
	
	#region UpcomTransactionsComparer
		
	/// <summary>
	///	Strongly Typed IComparer
	/// </summary>
	public class UpcomTransactionsComparer : System.Collections.Generic.IComparer<UpcomTransactions>
	{
		UpcomTransactionsColumn whichComparison;
		
		/// <summary>
        /// Initializes a new instance of the <see cref="T:UpcomTransactionsComparer"/> class.
        /// </summary>
		public UpcomTransactionsComparer()
        {            
        }               
        ...
        public UpcomTransactionsComparer(UpcomTransactionsColumn column)
        {
            this.whichComparison = column;
        }

		/// <summary>
        /// Determines whether the specified <c cref="UpcomTransactions"/> instances are considered equal.
        /// </summary>
        /// <param name="a">The first <c cref="UpcomTransactions"/> to compare.</param>
        /// <param name="b">The second <c>UpcomTransactions</c> to compare.</param>
        /// <returns>true if objA is the same instance as objB or if both are null references or if objA.Equals(objB) returns true; otherwise, false.</returns>
        public bool Equals(UpcomTransactions a, UpcomTransactions b)
        {
        ...
        /// <returns></returns>
        public int GetHashCode(UpcomTransactions entity)
        {
        ...
        /// <returns></returns>
        public int Compare(UpcomTransactions a, UpcomTransactions b)
        {
        ...
        public UpcomTransactionsColumn WhichComparison
        {
	...
	#region UpcomTransactionsKey Class

	/// <summary>
	/// Wraps the unique identifier values for the <see cref="UpcomTransactions"/> object.
	/// </summary>
	[Serializable]
	[CLSCompliant(true)]
	public class UpcomTransactionsKey : EntityKeyBase
	{
		#region Constructors
		
		/// <summary>
		/// Initializes a new instance of the UpcomTransactionsKey class.
		/// </summary>
		public UpcomTransactionsKey()
		{
		}
		...
		/// Initializes a new instance of the UpcomTransactionsKey class.
		/// </summary>
		public UpcomTransactionsKey(UpcomTransactionsBase entity)
		{
			this.Entity = entity;
		...
		/// Initializes a new instance of the UpcomTransactionsKey class.
		/// </summary>
		public UpcomTransactionsKey(System.Int64 _id)
		{
			#region Init Properties
		...
		private UpcomTransactionsBase _entity;
		
		/// <summary>
		/// Gets or sets the Entity property.
		/// </summary>
		public UpcomTransactionsBase Entity
		{
			get { return _entity; }
			set { _entity = value; }
		}
	...
	#region UpcomTransactionsColumn Enum
	
	/// <summary>
	/// Enumerate the UpcomTransactions columns.
	/// </summary>
	[Serializable]
	public enum UpcomTransactionsColumn : int
	{
		/// <summary>
		/// Id : 
		/// </summary>
	...
	#endregion UpcomTransactionsColumn Enum
