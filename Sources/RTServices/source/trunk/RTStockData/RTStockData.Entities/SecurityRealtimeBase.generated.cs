...
namespace RTStockData.Entities
{
	...
	{		
		...
		public SecurityRealtimeBase(System.DateTime? _tradeDate, System.Int16? _stockno, 
			...
			System.Int64? _currentRoom, System.Int64? _startRoom, System.Int64? _sequence, System.Boolean? _isVn30)
		{
			this.entityData = new SecurityRealtimeEntityData();
			this.backupData = null;
			...
			System.Int64? _currentRoom, System.Int64? _startRoom, System.Int64? _sequence, System.Boolean? _isVn30)
		{
            ...
            newSecurityRealtime.IsVn30 = _isVn30;
        ...
        /// <summary>
        /// 	Gets or sets the IsVn30 property. 
        ///		
        /// </summary>
        ...
        [DescriptionAttribute(@""), System.ComponentModel.Bindable(System.ComponentModel.BindableSupport.Yes)]
        [DataObjectField(false, false, true)]
        public virtual System.Boolean? IsVn30
        {
            get
            {
                return this.entityData.IsVn30;
            }

            set
            {
                if (this.entityData.IsVn30 == value)
                    return;

                OnColumnChanging(SecurityRealtimeColumn.IsVn30, this.entityData.IsVn30);
                this.entityData.IsVn30 = value;
                if (this.EntityState == EntityState.Unchanged)
                    this.EntityState = EntityState.Changed;
                OnColumnChanged(SecurityRealtimeColumn.IsVn30, this.entityData.IsVn30);
                OnPropertyChanged("IsVn30");
            }
        }
		...
		public bool IsPropertyChanged(SecurityRealtimeColumn column)
		{
			switch(column)
			{
                    ...
                    case SecurityRealtimeColumn.IsVn30:
                    return entityData.IsVn30 != _originalData.IsVn30;
		...
		public bool HasDataChanged()
		{
            ...
            result = result || entityData.IsVn30 != _originalData.IsVn30;
			return result;
		}	
	...
	#region Value Semantics Instance Equality
        ...
        public override int GetHashCode()
        {
			return this.Id.GetHashCode() ^ 
                    ...
                    ((this.IsVn30 == null) ? string.Empty : this.IsVn30.ToString()).GetHashCode();
        }
		...
		public static bool ValueEquals(SecurityRealtimeBase Object1, SecurityRealtimeBase Object2)
		{
            ...
            if (Object1.IsVn30 != null && Object2.IsVn30 != null)
            {
                if (Object1.IsVn30 != Object2.IsVn30)
                    equal = false;
            }
            else if (Object1.IsVn30 == null ^ Object2.IsVn30 == null)
            {
                equal = false;
            }		
			return equal;
...
/*
	...
	internal protected class SecurityRealtimeEntityData : ICloneable, ICloneableEx
	{
        ...
        /// IsVn30 : 
        /// </summary>
        public System.Boolean? IsVn30 = null;
		#endregion
	...
	public enum SecurityRealtimeColumn : int
	{
        ...
        /// IsVn30 : 
        /// </summary>
        [EnumTextValue("IsVn30")]
        [ColumnEnum("IsVn30", typeof(System.Boolean), System.Data.DbType.Boolean, false, false, true)]
        IsVn30=61
	}//End enum
