...
{		
	...
	public partial class LanguageServiceBase : ServiceBase<Language, LanguageKey>
	{
		...
		public static Language CreateLanguage(System.String _languageId, System.String _languageName, System.String _languageCode, System.Int32? _order)
		{
			Language newEntityLanguage = new Language();
			newEntityLanguage.LanguageId  = _languageId;
			newEntityLanguage.LanguageName  = _languageName;
			newEntityLanguage.LanguageCode  = _languageCode;
			newEntityLanguage.Order  = _order;
		...
		{
			return GetByLanguageId(key.LanguageId);
		}

		/// <summary>
		///  method that Gets rows in a <see cref="TList{Language}" /> from the datasource based on the primary key PK_Language index.
		/// </summary>
		/// <param name="_languageId"></param>
		/// <returns>Returns an instance of the <see cref="Language"/> class.</returns>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual Language GetByLanguageId(System.String _languageId)
		{
            ...
            {	
				...
				entity = dataProvider.LanguageProvider.GetByLanguageId(transactionManager, _languageId)   as Language;
			}
            catch (Exception exc)
            {
		...
		/// <returns>Returns an instance of the <see cref="Language"/> class.</returns>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual Language GetByLanguageId(System.String _languageId, int start, int pageLength, out int totalCount)
		{
			#region Security check
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("GetByLanguageId");
            ...
            {	
				...
				entity = dataProvider.LanguageProvider.GetByLanguageId(transactionManager, _languageId, start, pageLength, out totalCount)   as Language;
			}
            catch (Exception exc)
            {
				#region Handle transaction rollback and exception
		...
		public override TList<Language> GetAll() 
		{
            ...
            {	
				...
				list = dataProvider.LanguageProvider.GetAll(transactionManager);	
			}
            catch (Exception exc)
            {
				#region Handle transaction rollback and exception
		...
		public virtual TList<Language> Find(string whereClause)
		{
            ...
            {	
				...
				list = dataProvider.LanguageProvider.Find(transactionManager, whereClause);
			}
            catch (Exception exc)
            {
				#region Handle transaction rollback and exception
        ...
        /// <returns>Returns a typed collection of <c>Language</c> objects.</returns>
        public virtual TList<Language> Find(IFilterParameterCollection parameters, ISortColumnCollection sortColumns)
        {
		...
		public virtual TList<Language> Find(IFilterParameterCollection parameters, string orderBy)
		{
            ...
            {	
				...
				list = dataProvider.LanguageProvider.Find(transactionManager, parameters, orderBy);
			}
            catch (Exception exc)
            {
				#region Handle transaction rollback and exception
        ...
        /// <returns>Returns a typed collection of <c>Language</c> objects.</returns>
        public virtual TList<Language> Find(IFilterParameterCollection parameters, ISortColumnCollection sortColumns, int start, int pageLength, out int count)
        {
		...
		public virtual TList<Language> Insert(TList<Language> entityCollection)
		{
			...
			{
				throw new EntityNotValidException(entityCollection, "Insert", DomainUtil.GetErrorsFromList<Language>(entityCollection));
			}
			#endregion Security and validation check
		...
		public virtual TList<Language> Update(TList<Language> entityCollection)
		{
			...
			if (!entityCollection.IsValid)
			{
				throw new EntityNotValidException(entityCollection, "Update", DomainUtil.GetErrorsFromList<Language>(entityCollection));
			}
			#endregion Security and validation check
		...
		public virtual TList<Language> Save(TList<Language> entityCollection)
		{
			...
			if (!entityCollection.IsValid)
			{
				throw new EntityNotValidException(entityCollection, "Save", DomainUtil.GetErrorsFromList<Language>(entityCollection));
			}
			#endregion Security and validation check
		...
		public virtual TList<Language> Delete(TList<Language> entityCollection)
		{
			...
			if (!entityCollection.IsValid)
			{
				throw new EntityNotValidException(entityCollection, "Delete", DomainUtil.GetErrorsFromList<Language>(entityCollection));
			}
			#endregion Security and validation check
		...
		/// <returns>Returns true if operation suceeded.</returns>
		[DataObjectMethod(DataObjectMethodType.Delete)]
		public virtual bool Delete(System.String _languageId)
		{
			#region Security check
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("Delete");
			...
			try
            {
				...
				result = dataProvider.LanguageProvider.Delete(transactionManager, _languageId);
		...
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual Language DeepLoadByLanguageId(System.String _languageId, bool deep, DeepLoadType deepLoadType, params System.Type[] childTypes)
		{
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("DeepLoadByLanguageId");		    
			bool isBorrowedTransaction = ConnectionScope.Current.HasTransaction;				
	
			Language entity = GetByLanguageId(_languageId);
