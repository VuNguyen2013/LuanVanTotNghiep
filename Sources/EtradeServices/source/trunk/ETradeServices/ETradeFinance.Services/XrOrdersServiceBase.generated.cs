...
{		
	...
	/// All custom implementations should be done in the <see cref="XrOrders"/> class.
	/// </remarks>
	[DataObject]
	[CLSCompliant(true)]
	public partial class XrOrdersServiceBase : ServiceBase<XrOrders, XrOrdersKey>
	{

		#region Constructors
		///<summary>
		/// Creates a new <see cref="XrOrders"/> instance .
		///</summary>
		public XrOrdersServiceBase() : base()
		{
		}
		...
		public static XrOrders CreateXrOrders(System.String _subAccountId, System.Int64 _buyRightId, System.String _secSymbol, System.String _market, System.Int64? _volume, System.Decimal? _price, System.Int64? _registeredVol, System.Int64? _availableVol, System.Int64? _requestVol, System.DateTime? _requestTime, System.Int64? _approvedVol, System.Int32 _status, System.String _brokerId, System.DateTime? _execTime, System.String _note)
		{
			XrOrders newEntityXrOrders = new XrOrders();
			newEntityXrOrders.SubAccountId  = _subAccountId;
			newEntityXrOrders.BuyRightId  = _buyRightId;
			newEntityXrOrders.SecSymbol  = _secSymbol;
			newEntityXrOrders.Market  = _market;
			newEntityXrOrders.Volume  = _volume;
			newEntityXrOrders.Price  = _price;
			newEntityXrOrders.RegisteredVol  = _registeredVol;
			newEntityXrOrders.AvailableVol  = _availableVol;
			newEntityXrOrders.RequestVol  = _requestVol;
			newEntityXrOrders.RequestTime  = _requestTime;
			newEntityXrOrders.ApprovedVol  = _approvedVol;
			newEntityXrOrders.Status  = _status;
			newEntityXrOrders.BrokerId  = _brokerId;
			newEntityXrOrders.ExecTime  = _execTime;
			newEntityXrOrders.Note  = _note;
			return newEntityXrOrders;
		}
		#endregion Constructors


		#region Fields
		private static SecurityContext<XrOrders> securityContext = new SecurityContext<XrOrders>();
		...
		///</summary>
		public static SecurityContext<XrOrders> SecurityContext
		{
			get
			{
		...
		public override XrOrders Get(XrOrdersKey key)
		{
			return GetById(key.Id);
		}

		/// <summary>
		///  method that Gets rows in a <see cref="TList{XrOrders}" /> from the datasource based on the primary key PK_XRORDERS index.
		/// </summary>
		/// <param name="_id"></param>
		/// <returns>Returns an instance of the <see cref="XrOrders"/> class.</returns>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual XrOrders GetById(System.Int64 _id)
		{
            ...
            {	
				...
				entity = dataProvider.XrOrdersProvider.GetById(transactionManager, _id)   as XrOrders;
			}
            catch (Exception exc)
            {
		...
		/// <returns>Returns an instance of the <see cref="XrOrders"/> class.</returns>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual XrOrders GetById(System.Int64 _id, int start, int pageLength, out int totalCount)
		{
			#region Security check
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("GetById");
            ...
            {	
				...
				entity = dataProvider.XrOrdersProvider.GetById(transactionManager, _id, start, pageLength, out totalCount)   as XrOrders;
			}
            catch (Exception exc)
            {
				#region Handle transaction rollback and exception
		...
		#region GetAll
		/// <summary>
		/// Get a complete collection of <see cref="XrOrders" /> entities.
		/// </summary>
		/// <returns></returns>
		public override TList<XrOrders> GetAll() 
		{
			#region Security check
			// throws security exception if not authorized
            ...
            {	
				...
				list = dataProvider.XrOrdersProvider.GetAll(transactionManager);	
			}
            catch (Exception exc)
            {
				#region Handle transaction rollback and exception
		...
		/// <summary>
		/// Get a set portion of a complete list of <see cref="XrOrders" /> entities
		/// </summary>
		/// <param name="start">Row number at which to start reading.</param>
		/// <param name="pageLength">Number of rows to return.</param>
		/// <param name="totalCount">out parameter, number of total rows in given query.</param>
		/// <returns>a <see cref="TList{XrOrders}"/> </returns>
		public virtual TList<XrOrders> GetAll(int start, int pageLength, out int totalCount) 
		{
			#region Security check
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("GetAll");
            ...
            {	
				...
				list = dataProvider.XrOrdersProvider.GetAll(transactionManager, start, pageLength, out totalCount);	
			}
            catch (Exception exc)
            {
				#region Handle transaction rollback and exception
		...
		#region GetPaged
		/// <summary>
		/// Gets a page of <see cref="TList{XrOrders}" /> rows from the DataSource.
		/// </summary>
		/// <param name="totalCount">Out Parameter, Number of rows in the DataSource.</param>
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of <c>XrOrders</c> objects.</returns>
		public virtual TList<XrOrders> GetPaged(out int totalCount)
		{
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of <c>XrOrders</c> objects.</returns>
		public virtual TList<XrOrders> GetPaged(int start, int pageLength, out int totalCount)
		{
			return GetPaged(null, null, start, pageLength, out totalCount);
		}

		/// <summary>
		/// Gets a page of entity rows with a <see cref="TList{XrOrders}" /> from the DataSource with a where clause and order by clause.
		/// </summary>
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of <c>XrOrders</c> objects.</returns>
		public override TList<XrOrders> GetPaged(string whereClause,string orderBy, int start, int pageLength, out int totalCount)
		{
			#region Security check
			// throws security exception if not authorized
            ...
            {	
				...
				list = dataProvider.XrOrdersProvider.GetPaged(transactionManager, whereClause, orderBy, start, pageLength, out totalCount);
			}
            catch (Exception exc)
            {
				#region Handle transaction rollback and exception
		...
		public virtual TList<XrOrders> Find(string whereClause)
		{
			#region Security check
			// throws security exception if not authorized
            ...
            {	
				...
				list = dataProvider.XrOrdersProvider.Find(transactionManager, whereClause);
			}
            catch (Exception exc)
            {
				#region Handle transaction rollback and exception
		...
		public override TList<XrOrders> Find(string whereClause, int start, int pageLength, out int totalCount)
		{
			#region Security check
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("Find");
            ...
            {	
				...
				list = dataProvider.XrOrdersProvider.Find(transactionManager, whereClause, start, pageLength, out totalCount);
			}
            catch (Exception exc)
            {
				#region Handle transaction rollback and exception
		...
		/// <returns>Returns a typed collection of <c>XrOrders</c> objects.</returns>
		public virtual TList<XrOrders> Find(IFilterParameterCollection parameters)
		{
        ...
        /// <returns>Returns a typed collection of <c>XrOrders</c> objects.</returns>
        public virtual TList<XrOrders> Find(IFilterParameterCollection parameters, ISortColumnCollection sortColumns)
        {
		...
		/// <param name="orderBy">Specifies the sort criteria for the rows in the DataSource (Name ASC; BirthDay DESC, Name ASC);</param>
		/// <returns>Returns a typed collection of <c>XrOrders</c> objects.</returns>
		public virtual TList<XrOrders> Find(IFilterParameterCollection parameters, string orderBy)
		{
			#region Security check
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("Find");
            ...
            {	
				...
				list = dataProvider.XrOrdersProvider.Find(transactionManager, parameters, orderBy);
			}
            catch (Exception exc)
            {
				#region Handle transaction rollback and exception
        ...
        /// <returns>Returns a typed collection of <c>XrOrders</c> objects.</returns>
        public virtual TList<XrOrders> Find(IFilterParameterCollection parameters, ISortColumnCollection sortColumns, int start, int pageLength, out int count)
        {
		...
		/// <param name="count">out. The number of rows that match this query.</param>
		/// <returns>Returns a typed collection of <c>XrOrders</c> objects.</returns>
		public virtual TList<XrOrders> Find(IFilterParameterCollection parameters, string orderBy, int start, int pageLength, out int count)
		{
			#region Security check
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("Find");
            ...
            {	
				...
				list = dataProvider.XrOrdersProvider.Find(transactionManager, parameters, orderBy, start, pageLength, out count);
			}
            catch (Exception exc)
            {
				#region Handle transaction rollback and exception
		...
		public override bool Insert(XrOrders entity)
		{
            ...
            {	
				...
				result = dataProvider.XrOrdersProvider.Insert(transactionManager, entity); 
		...
		/// <summary>
		/// public virtual method that Inserts rows in <see cref="TList{XrOrders}" /> to the datasource.
		/// </summary>
		/// <param name="entityCollection"><c>XrOrders</c> objects in a <see cref="TList{XrOrders}" /> object to Insert.</param>
		/// <remarks>
        ...
        /// </example>
		[DataObjectMethod(DataObjectMethodType.Insert)]
		public virtual TList<XrOrders> Insert(TList<XrOrders> entityCollection)
		{
			#region Security and validation check
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("Insert");
			...
			{
				throw new EntityNotValidException(entityCollection, "Insert", DomainUtil.GetErrorsFromList<XrOrders>(entityCollection));
			}
			#endregion Security and validation check
			...
			try
            {
				...
				dataProvider.XrOrdersProvider.Insert(transactionManager, entityCollection); 
		...
		public override bool Update(XrOrders entity)
		{
			#region Security and validation check
			// throws security exception if not authorized
            ...
            {	
				...
				result = dataProvider.XrOrdersProvider.Update(transactionManager, entity); 
		...
		/// <summary>
		/// public virtual method that Updates rows in <see cref="TList{XrOrders}" /> to the datasource.
		/// </summary>
		/// <param name="entityCollection"><c>XrOrders</c> objects in a <see cref="TList{XrOrders}" /> object to Update.</param>
		/// <remarks>
        ...
        /// </example>
		[DataObjectMethod(DataObjectMethodType.Update)]
		public virtual TList<XrOrders> Update(TList<XrOrders> entityCollection)
		{
			#region Security and validation check
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("Update");
			...
			if (!entityCollection.IsValid)
			{
				throw new EntityNotValidException(entityCollection, "Update", DomainUtil.GetErrorsFromList<XrOrders>(entityCollection));
			}
			#endregion Security and validation check
			...
			try
            {
				...
				dataProvider.XrOrdersProvider.Update(transactionManager, entityCollection); 
        ...
        /// </example>
		[DataObjectMethod(DataObjectMethodType.Update)]
		public override XrOrders Save(XrOrders entity)
		{
			#region Security and validation check
			// throws security exception if not authorized
            ...
            {	
				...
				dataProvider.XrOrdersProvider.Save(transactionManager, entity); 
		...
		/// <summary>
		/// public virtual method that Saves rows in <see cref="TList{XrOrders}" /> to the datasource.
		/// </summary>
		/// <param name="entityCollection"><c>XrOrders</c> objects in a <see cref="TList{XrOrders}" /> object to Save.</param>
		/// <remarks>
        ...
        /// </example>
		[DataObjectMethod(DataObjectMethodType.Update)]
		public virtual TList<XrOrders> Save(TList<XrOrders> entityCollection)
		{
			#region Security and validation check
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("Save");
			...
			if (!entityCollection.IsValid)
			{
				throw new EntityNotValidException(entityCollection, "Save", DomainUtil.GetErrorsFromList<XrOrders>(entityCollection));
			}
			#endregion Security and validation check
			...
			try
            {
				...
				dataProvider.XrOrdersProvider.Save(transactionManager, entityCollection); 
		...
		public override bool Delete(XrOrders entity)
		{
			#region Security and validation check
			// throws security exception if not authorized
            ...
            {	
				...
				result = dataProvider.XrOrdersProvider.Delete(transactionManager, entity); 
		...
		/// <summary>
		/// public virtual method that Deletes rows in <see cref="TList{XrOrders}" /> to the datasource.
		/// </summary>
		/// <param name="entityCollection"><c>XrOrders</c> objects in a <see cref="TList{XrOrders}" /> object to Delete.</param>
		/// <remarks>
        ...
        /// </example>
		[DataObjectMethod(DataObjectMethodType.Delete)]
		public virtual TList<XrOrders> Delete(TList<XrOrders> entityCollection)
		{
			#region Security and validation check
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("Delete");
			...
			if (!entityCollection.IsValid)
			{
				throw new EntityNotValidException(entityCollection, "Delete", DomainUtil.GetErrorsFromList<XrOrders>(entityCollection));
			}
			#endregion Security and validation check
			...
			try
            {
				...
				dataProvider.XrOrdersProvider.Delete(transactionManager, entityCollection); 
		...
		public bool Delete(XrOrdersKey key)
		{
		...
		public virtual bool Delete(System.Int64 _id)
		{
			...
			try
            {
				...
				result = dataProvider.XrOrdersProvider.Delete(transactionManager, _id);
		...
		/// <summary>
		/// public virtualDeep Loads the requested <see cref="XrOrders"/> by the entity keys.  The criteria of the child 
		...
		/// <returns>Returns an instance of the <see cref="XrOrders"/> class and DeepLoaded.</returns>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual XrOrders DeepLoadById(System.Int64 _id, bool deep, DeepLoadType deepLoadType, params System.Type[] childTypes)
		{
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("DeepLoadById");		    
			bool isBorrowedTransaction = ConnectionScope.Current.HasTransaction;				
	
			XrOrders entity = GetById(_id);
		...
		/// <remarks>
		/// <seealso cref="DeepLoad(XrOrders)"/> overloaded methods for a recursive N Level deep loading method.
		/// </remarks>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual void DeepLoad(XrOrders entity)
		{
		...
		/// <param name="deep">Boolean. A flag that indicates whether to recursively save all Property Collection that are descendants of this instance. If True, saves the complete object graph below this object. If False, saves this object only. </param>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual void DeepLoad(XrOrders entity, bool deep)
		{
		...
		/// </remarks>
		/// <param name="entity">The <see cref="XrOrders"/> object to load.</param>
		...
		/// <param name="childTypes">XrOrders Property Collection Type Array To Include or Exclude from Load</param>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual void DeepLoad(XrOrders entity, bool deep, DeepLoadType deepLoadType, params System.Type[] childTypes)
		{
			#region Security check
			// throws security exception if not authorized
			...
			try
            {
				...
				dataProvider.XrOrdersProvider.DeepLoad(transactionManager, entity, deep, deepLoadType, childTypes);
			}
            catch (Exception exc)
            {
				#region Handle transaction rollback and exception
		...
		/// <summary>
		/// Deep Loads the <see cref="TList{XrOrders}" /> object with all of the child 
		/// property collections only 1 Level Deep.
		/// </summary>
		/// <remarks>
		/// <seealso cref="DeepLoad(XrOrders)"/> overloaded methods for a recursive N Level deep loading method.
		/// </remarks>
		/// <param name="entityCollection">the <see cref="TList{XrOrders}" /> Object to deep loads.</param>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual void DeepLoad(TList<XrOrders> entityCollection)
		{
			DeepLoad(entityCollection, false, DeepLoadType.ExcludeChildren, System.Type.EmptyTypes);
		}
		
		/// <summary>
		/// Deep Loads the <see cref="TList{XrOrders}" /> object.
		/// </summary>
		/// <remarks>
		/// <seealso cref="DeepLoad(XrOrders)"/> overloaded methods for a recursive N Level deep loading method.
		/// </remarks>
		...
		/// <param name="deep">Boolean. A flag that indicates whether to recursively save all Property Collection that are descendants of this instance. If True, saves the complete object graph below this object. If False, saves this object only. </param>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual void DeepLoad(TList<XrOrders> entityCollection, bool deep)
		{
			DeepLoad(entityCollection, deep, DeepLoadType.ExcludeChildren, System.Type.EmptyTypes);
		}	

		/// <summary>
		/// Deep Loads the entire <see cref="TList{XrOrders}" /> object with criteria based of the child 
		/// property collections only N Levels Deep based on the DeepLoadType.
		/// </summary>
		/// <remarks>
		/// Use this method with caution as it is possible to DeepLoad with Recursion and traverse an entire collection's object graph.
		/// </remarks>
		/// <param name="entityCollection">The <see cref="TList{XrOrders}" /> instance to load.</param>
		/// <param name="deep">Boolean. A flag that indicates whether to recursively save all Property Collection that are descendants of this instance. If True, saves the complete object graph below this object. If False, saves this object only. </param>
		...
		///	</param>
		/// <param name="childTypes"><see cref="XrOrders"/> Property Collection Type Array To Include or Exclude from Load</param>
		[DataObjectMethod(DataObjectMethodType.Select, false)]
		public override void DeepLoad(TList<XrOrders> entityCollection, bool deep, DeepLoadType deepLoadType, params System.Type[] childTypes)
		{	
			#region Security check
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("DeepLoad");
			...
			try
            {
				...
				dataProvider.XrOrdersProvider.DeepLoad(transactionManager, entityCollection, deep, deepLoadType, childTypes);
			}
            catch (Exception exc)
            {
				#region Handle transaction rollback and exception
		...
		/// <summary>
		/// public virtualDeep Saves the <see cref="XrOrders"/> object with all of the child
		/// property collections N Levels Deep.
		/// </summary>
		/// <param name="entity">XrOrders Object</param>
		[DataObjectMethod(DataObjectMethodType.Update)]
		public override bool DeepSave(XrOrders entity)
		{
		...
		[DataObjectMethod(DataObjectMethodType.Update)]
		public override bool DeepSave(XrOrders entity, DeepSaveType deepSaveType, params System.Type[] childTypes)
		{
			#region Security and validation check
			// throws security exception if not authorized
            ...
            {	
				...
				result = dataProvider.XrOrdersProvider.DeepSave(transactionManager, entity, deepSaveType, childTypes);
		...
		/// <summary>
		/// Deep Save the entire <see cref="TList{XrOrders}" /> object with all of the child 
		/// property collections.
		/// </summary>
		/// <param name="entityCollection">TList{XrOrders} Object</param>
		[DataObjectMethod(DataObjectMethodType.Update)]
		public virtual bool DeepSave(TList<XrOrders> entityCollection)
		{
			return DeepSave(entityCollection, DeepSaveType.ExcludeChildren, System.Type.EmptyTypes);
		}
		
		/// <summary>
		/// Deep Save the entire object graph of the <see cref="TList{XrOrders}" /> object with criteria based of the child 
		/// property collections.
		/// </summary>
		/// <param name="entityCollection"><see cref="TList{XrOrders}" /> Object</param>
		/// <param name="deepSaveType">DeepSaveType Enumeration to Include/Exclude object property collections from Save.</param>
		/// <param name="childTypes">XrOrders Property Collection Type Array To Include or Exclude from Save</param>
		[DataObjectMethod(DataObjectMethodType.Update)]
		public override bool DeepSave(TList<XrOrders> entityCollection, DeepSaveType deepSaveType, params System.Type[] childTypes)
		{	
			#region Security and validation check
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("DeepSave");
			...
			try
            {
				...
				result = dataProvider.XrOrdersProvider.DeepSave(transactionManager, entityCollection,  deepSaveType, childTypes);
