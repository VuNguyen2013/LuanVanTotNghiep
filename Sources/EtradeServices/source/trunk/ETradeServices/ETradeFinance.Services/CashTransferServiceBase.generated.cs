...
{		
	...
	/// All custom implementations should be done in the <see cref="CashTransfer"/> class.
	/// </remarks>
	[DataObject]
	[CLSCompliant(true)]
	public partial class CashTransferServiceBase : ServiceBase<CashTransfer, CashTransferKey>
	{

		#region Constructors
		///<summary>
		/// Creates a new <see cref="CashTransfer"/> instance .
		///</summary>
		public CashTransferServiceBase() : base()
		{
		}
		...
		public static CashTransfer CreateCashTransfer(System.Decimal? _withdrawableAmt, System.Decimal? _transferedAmt, System.Decimal? _advOrderAmt, System.Decimal? _avilableAmt, decimal _requestAmt, System.DateTime _requestTime, System.Decimal? _fee, System.Decimal? _vat, System.Decimal? _amtAfterFee, string _srcAccountId, string _destAccountId, System.Int32? _transType, System.Int32? _status, System.DateTime? _execTime, System.Decimal? _approvedAmt, string _note, string _brokerId, string _bankName, string _branchName)
		{
			CashTransfer newEntityCashTransfer = new CashTransfer();
			newEntityCashTransfer.WithdrawableAmt  = _withdrawableAmt;
			newEntityCashTransfer.TransferedAmt  = _transferedAmt;
			newEntityCashTransfer.AdvOrderAmt  = _advOrderAmt;
			newEntityCashTransfer.AvilableAmt  = _avilableAmt;
			newEntityCashTransfer.RequestAmt  = _requestAmt;
			newEntityCashTransfer.RequestTime  = _requestTime;
			newEntityCashTransfer.Fee  = _fee;
			newEntityCashTransfer.Vat  = _vat;
			newEntityCashTransfer.AmtAfterFee  = _amtAfterFee;
			newEntityCashTransfer.SrcAccountId  = _srcAccountId;
			newEntityCashTransfer.DestAccountId  = _destAccountId;
			newEntityCashTransfer.TransType  = _transType;
			newEntityCashTransfer.Status  = _status;
			newEntityCashTransfer.ExecTime  = _execTime;
			newEntityCashTransfer.ApprovedAmt  = _approvedAmt;
			newEntityCashTransfer.Note  = _note;
			newEntityCashTransfer.BrokerId  = _brokerId;
			newEntityCashTransfer.BankName  = _bankName;
			newEntityCashTransfer.BranchName  = _branchName;
			return newEntityCashTransfer;
		}
		#endregion Constructors


		#region Fields
		private static SecurityContext<CashTransfer> securityContext = new SecurityContext<CashTransfer>();
		...
		///</summary>
		public static SecurityContext<CashTransfer> SecurityContext
		{
			get
			{
		...
		public override CashTransfer Get(CashTransferKey key)
		{
			return GetById(key.Id);
		}

		/// <summary>
		///  method that Gets rows in a <see cref="TList{CashTransfer}" /> from the datasource based on the primary key PK_CashTransfer index.
		/// </summary>
		/// <param name="_id">CashTransferID identifies CashTransfer</param>
		/// <returns>Returns an instance of the <see cref="CashTransfer"/> class.</returns>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual CashTransfer GetById(long _id)
		{
            ...
            {	
				...
				entity = dataProvider.CashTransferProvider.GetById(transactionManager, _id)   as CashTransfer;
			}
            catch (Exception exc)
            {
		...
		/// <returns>Returns an instance of the <see cref="CashTransfer"/> class.</returns>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual CashTransfer GetById(long _id, int start, int pageLength, out int totalCount)
		{
			#region Security check
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("GetById");
            ...
            {	
				...
				entity = dataProvider.CashTransferProvider.GetById(transactionManager, _id, start, pageLength, out totalCount)   as CashTransfer;
			}
            catch (Exception exc)
            {
				#region Handle transaction rollback and exception
		...
		#region GetAll
		/// <summary>
		/// Get a complete collection of <see cref="CashTransfer" /> entities.
		/// </summary>
		/// <returns></returns>
		public override TList<CashTransfer> GetAll() 
		{
			#region Security check
			// throws security exception if not authorized
            ...
            {	
				...
				list = dataProvider.CashTransferProvider.GetAll(transactionManager);	
			}
            catch (Exception exc)
            {
				#region Handle transaction rollback and exception
		...
		/// <summary>
		/// Get a set portion of a complete list of <see cref="CashTransfer" /> entities
		/// </summary>
		/// <param name="start">Row number at which to start reading.</param>
		/// <param name="pageLength">Number of rows to return.</param>
		/// <param name="totalCount">out parameter, number of total rows in given query.</param>
		/// <returns>a <see cref="TList{CashTransfer}"/> </returns>
		public virtual TList<CashTransfer> GetAll(int start, int pageLength, out int totalCount) 
		{
			#region Security check
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("GetAll");
            ...
            {	
				...
				list = dataProvider.CashTransferProvider.GetAll(transactionManager, start, pageLength, out totalCount);	
			}
            catch (Exception exc)
            {
				#region Handle transaction rollback and exception
		...
		#region GetPaged
		/// <summary>
		/// Gets a page of <see cref="TList{CashTransfer}" /> rows from the DataSource.
		/// </summary>
		/// <param name="totalCount">Out Parameter, Number of rows in the DataSource.</param>
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of <c>CashTransfer</c> objects.</returns>
		public virtual TList<CashTransfer> GetPaged(out int totalCount)
		{
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of <c>CashTransfer</c> objects.</returns>
		public virtual TList<CashTransfer> GetPaged(int start, int pageLength, out int totalCount)
		{
			return GetPaged(null, null, start, pageLength, out totalCount);
		}

		/// <summary>
		/// Gets a page of entity rows with a <see cref="TList{CashTransfer}" /> from the DataSource with a where clause and order by clause.
		/// </summary>
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of <c>CashTransfer</c> objects.</returns>
		public override TList<CashTransfer> GetPaged(string whereClause,string orderBy, int start, int pageLength, out int totalCount)
		{
			#region Security check
			// throws security exception if not authorized
            ...
            {	
				...
				list = dataProvider.CashTransferProvider.GetPaged(transactionManager, whereClause, orderBy, start, pageLength, out totalCount);
			}
            catch (Exception exc)
            {
				#region Handle transaction rollback and exception
		...
		public virtual TList<CashTransfer> Find(string whereClause)
		{
			#region Security check
			// throws security exception if not authorized
            ...
            {	
				...
				list = dataProvider.CashTransferProvider.Find(transactionManager, whereClause);
			}
            catch (Exception exc)
            {
				#region Handle transaction rollback and exception
		...
		public override TList<CashTransfer> Find(string whereClause, int start, int pageLength, out int totalCount)
		{
			#region Security check
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("Find");
            ...
            {	
				...
				list = dataProvider.CashTransferProvider.Find(transactionManager, whereClause, start, pageLength, out totalCount);
			}
            catch (Exception exc)
            {
				#region Handle transaction rollback and exception
		...
		/// <returns>Returns a typed collection of <c>CashTransfer</c> objects.</returns>
		public virtual TList<CashTransfer> Find(IFilterParameterCollection parameters)
		{
        ...
        /// <returns>Returns a typed collection of <c>CashTransfer</c> objects.</returns>
        public virtual TList<CashTransfer> Find(IFilterParameterCollection parameters, ISortColumnCollection sortColumns)
        {
		...
		/// <param name="orderBy">Specifies the sort criteria for the rows in the DataSource (Name ASC; BirthDay DESC, Name ASC);</param>
		/// <returns>Returns a typed collection of <c>CashTransfer</c> objects.</returns>
		public virtual TList<CashTransfer> Find(IFilterParameterCollection parameters, string orderBy)
		{
			#region Security check
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("Find");
            ...
            {	
				...
				list = dataProvider.CashTransferProvider.Find(transactionManager, parameters, orderBy);
			}
            catch (Exception exc)
            {
				#region Handle transaction rollback and exception
        ...
        /// <returns>Returns a typed collection of <c>CashTransfer</c> objects.</returns>
        public virtual TList<CashTransfer> Find(IFilterParameterCollection parameters, ISortColumnCollection sortColumns, int start, int pageLength, out int count)
        {
		...
		/// <param name="count">out. The number of rows that match this query.</param>
		/// <returns>Returns a typed collection of <c>CashTransfer</c> objects.</returns>
		public virtual TList<CashTransfer> Find(IFilterParameterCollection parameters, string orderBy, int start, int pageLength, out int count)
		{
			#region Security check
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("Find");
            ...
            {	
				...
				list = dataProvider.CashTransferProvider.Find(transactionManager, parameters, orderBy, start, pageLength, out count);
			}
            catch (Exception exc)
            {
				#region Handle transaction rollback and exception
		...
		public override bool Insert(CashTransfer entity)
		{
            ...
            {	
				...
				result = dataProvider.CashTransferProvider.Insert(transactionManager, entity); 
		...
		/// <summary>
		/// public virtual method that Inserts rows in <see cref="TList{CashTransfer}" /> to the datasource.
		/// </summary>
		/// <param name="entityCollection"><c>CashTransfer</c> objects in a <see cref="TList{CashTransfer}" /> object to Insert.</param>
		/// <remarks>
        ...
        /// </example>
		[DataObjectMethod(DataObjectMethodType.Insert)]
		public virtual TList<CashTransfer> Insert(TList<CashTransfer> entityCollection)
		{
			#region Security and validation check
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("Insert");
			...
			{
				throw new EntityNotValidException(entityCollection, "Insert", DomainUtil.GetErrorsFromList<CashTransfer>(entityCollection));
			}
			#endregion Security and validation check
			...
			try
            {
				...
				dataProvider.CashTransferProvider.Insert(transactionManager, entityCollection); 
		...
		public override bool Update(CashTransfer entity)
		{
			#region Security and validation check
			// throws security exception if not authorized
            ...
            {	
				...
				result = dataProvider.CashTransferProvider.Update(transactionManager, entity); 
		...
		/// <summary>
		/// public virtual method that Updates rows in <see cref="TList{CashTransfer}" /> to the datasource.
		/// </summary>
		/// <param name="entityCollection"><c>CashTransfer</c> objects in a <see cref="TList{CashTransfer}" /> object to Update.</param>
		/// <remarks>
        ...
        /// </example>
		[DataObjectMethod(DataObjectMethodType.Update)]
		public virtual TList<CashTransfer> Update(TList<CashTransfer> entityCollection)
		{
			#region Security and validation check
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("Update");
			...
			if (!entityCollection.IsValid)
			{
				throw new EntityNotValidException(entityCollection, "Update", DomainUtil.GetErrorsFromList<CashTransfer>(entityCollection));
			}
			#endregion Security and validation check
			...
			try
            {
				...
				dataProvider.CashTransferProvider.Update(transactionManager, entityCollection); 
        ...
        /// </example>
		[DataObjectMethod(DataObjectMethodType.Update)]
		public override CashTransfer Save(CashTransfer entity)
		{
			#region Security and validation check
			// throws security exception if not authorized
            ...
            {	
				...
				dataProvider.CashTransferProvider.Save(transactionManager, entity); 
		...
		/// <summary>
		/// public virtual method that Saves rows in <see cref="TList{CashTransfer}" /> to the datasource.
		/// </summary>
		/// <param name="entityCollection"><c>CashTransfer</c> objects in a <see cref="TList{CashTransfer}" /> object to Save.</param>
		/// <remarks>
        ...
        /// </example>
		[DataObjectMethod(DataObjectMethodType.Update)]
		public virtual TList<CashTransfer> Save(TList<CashTransfer> entityCollection)
		{
			#region Security and validation check
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("Save");
			...
			if (!entityCollection.IsValid)
			{
				throw new EntityNotValidException(entityCollection, "Save", DomainUtil.GetErrorsFromList<CashTransfer>(entityCollection));
			}
			#endregion Security and validation check
			...
			try
            {
				...
				dataProvider.CashTransferProvider.Save(transactionManager, entityCollection); 
		...
		public override bool Delete(CashTransfer entity)
		{
			#region Security and validation check
			// throws security exception if not authorized
            ...
            {	
				...
				result = dataProvider.CashTransferProvider.Delete(transactionManager, entity); 
		...
		/// <summary>
		/// public virtual method that Deletes rows in <see cref="TList{CashTransfer}" /> to the datasource.
		/// </summary>
		/// <param name="entityCollection"><c>CashTransfer</c> objects in a <see cref="TList{CashTransfer}" /> object to Delete.</param>
		/// <remarks>
        ...
        /// </example>
		[DataObjectMethod(DataObjectMethodType.Delete)]
		public virtual TList<CashTransfer> Delete(TList<CashTransfer> entityCollection)
		{
			#region Security and validation check
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("Delete");
			...
			if (!entityCollection.IsValid)
			{
				throw new EntityNotValidException(entityCollection, "Delete", DomainUtil.GetErrorsFromList<CashTransfer>(entityCollection));
			}
			#endregion Security and validation check
			...
			try
            {
				...
				dataProvider.CashTransferProvider.Delete(transactionManager, entityCollection); 
		...
		public bool Delete(CashTransferKey key)
		{
		...
		public virtual bool Delete(long _id)
		{
			...
			try
            {
				...
				result = dataProvider.CashTransferProvider.Delete(transactionManager, _id);
		...
		/// <summary>
		/// public virtualDeep Loads the requested <see cref="CashTransfer"/> by the entity keys.  The criteria of the child 
		...
		/// <returns>Returns an instance of the <see cref="CashTransfer"/> class and DeepLoaded.</returns>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual CashTransfer DeepLoadById(long _id, bool deep, DeepLoadType deepLoadType, params System.Type[] childTypes)
		{
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("DeepLoadById");		    
			bool isBorrowedTransaction = ConnectionScope.Current.HasTransaction;				
	
			CashTransfer entity = GetById(_id);
		...
		/// <remarks>
		/// <seealso cref="DeepLoad(CashTransfer)"/> overloaded methods for a recursive N Level deep loading method.
		/// </remarks>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual void DeepLoad(CashTransfer entity)
		{
		...
		/// <param name="deep">Boolean. A flag that indicates whether to recursively save all Property Collection that are descendants of this instance. If True, saves the complete object graph below this object. If False, saves this object only. </param>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual void DeepLoad(CashTransfer entity, bool deep)
		{
		...
		/// </remarks>
		/// <param name="entity">The <see cref="CashTransfer"/> object to load.</param>
		...
		/// <param name="childTypes">CashTransfer Property Collection Type Array To Include or Exclude from Load</param>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual void DeepLoad(CashTransfer entity, bool deep, DeepLoadType deepLoadType, params System.Type[] childTypes)
		{
			#region Security check
			// throws security exception if not authorized
			...
			try
            {
				...
				dataProvider.CashTransferProvider.DeepLoad(transactionManager, entity, deep, deepLoadType, childTypes);
			}
            catch (Exception exc)
            {
				#region Handle transaction rollback and exception
		...
		/// <summary>
		/// Deep Loads the <see cref="TList{CashTransfer}" /> object with all of the child 
		/// property collections only 1 Level Deep.
		/// </summary>
		/// <remarks>
		/// <seealso cref="DeepLoad(CashTransfer)"/> overloaded methods for a recursive N Level deep loading method.
		/// </remarks>
		/// <param name="entityCollection">the <see cref="TList{CashTransfer}" /> Object to deep loads.</param>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual void DeepLoad(TList<CashTransfer> entityCollection)
		{
			DeepLoad(entityCollection, false, DeepLoadType.ExcludeChildren, System.Type.EmptyTypes);
		}
		
		/// <summary>
		/// Deep Loads the <see cref="TList{CashTransfer}" /> object.
		/// </summary>
		/// <remarks>
		/// <seealso cref="DeepLoad(CashTransfer)"/> overloaded methods for a recursive N Level deep loading method.
		/// </remarks>
		...
		/// <param name="deep">Boolean. A flag that indicates whether to recursively save all Property Collection that are descendants of this instance. If True, saves the complete object graph below this object. If False, saves this object only. </param>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual void DeepLoad(TList<CashTransfer> entityCollection, bool deep)
		{
			DeepLoad(entityCollection, deep, DeepLoadType.ExcludeChildren, System.Type.EmptyTypes);
		}	

		/// <summary>
		/// Deep Loads the entire <see cref="TList{CashTransfer}" /> object with criteria based of the child 
		/// property collections only N Levels Deep based on the DeepLoadType.
		/// </summary>
		/// <remarks>
		/// Use this method with caution as it is possible to DeepLoad with Recursion and traverse an entire collection's object graph.
		/// </remarks>
		/// <param name="entityCollection">The <see cref="TList{CashTransfer}" /> instance to load.</param>
		/// <param name="deep">Boolean. A flag that indicates whether to recursively save all Property Collection that are descendants of this instance. If True, saves the complete object graph below this object. If False, saves this object only. </param>
		...
		///	</param>
		/// <param name="childTypes"><see cref="CashTransfer"/> Property Collection Type Array To Include or Exclude from Load</param>
		[DataObjectMethod(DataObjectMethodType.Select, false)]
		public override void DeepLoad(TList<CashTransfer> entityCollection, bool deep, DeepLoadType deepLoadType, params System.Type[] childTypes)
		{	
			#region Security check
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("DeepLoad");
			...
			try
            {
				...
				dataProvider.CashTransferProvider.DeepLoad(transactionManager, entityCollection, deep, deepLoadType, childTypes);
			}
            catch (Exception exc)
            {
				#region Handle transaction rollback and exception
		...
		/// <summary>
		/// public virtualDeep Saves the <see cref="CashTransfer"/> object with all of the child
		/// property collections N Levels Deep.
		/// </summary>
		/// <param name="entity">CashTransfer Object</param>
		[DataObjectMethod(DataObjectMethodType.Update)]
		public override bool DeepSave(CashTransfer entity)
		{
		...
		[DataObjectMethod(DataObjectMethodType.Update)]
		public override bool DeepSave(CashTransfer entity, DeepSaveType deepSaveType, params System.Type[] childTypes)
		{
			#region Security and validation check
			// throws security exception if not authorized
            ...
            {	
				...
				result = dataProvider.CashTransferProvider.DeepSave(transactionManager, entity, deepSaveType, childTypes);
		...
		/// <summary>
		/// Deep Save the entire <see cref="TList{CashTransfer}" /> object with all of the child 
		/// property collections.
		/// </summary>
		/// <param name="entityCollection">TList{CashTransfer} Object</param>
		[DataObjectMethod(DataObjectMethodType.Update)]
		public virtual bool DeepSave(TList<CashTransfer> entityCollection)
		{
			return DeepSave(entityCollection, DeepSaveType.ExcludeChildren, System.Type.EmptyTypes);
		}
		
		/// <summary>
		/// Deep Save the entire object graph of the <see cref="TList{CashTransfer}" /> object with criteria based of the child 
		/// property collections.
		/// </summary>
		/// <param name="entityCollection"><see cref="TList{CashTransfer}" /> Object</param>
		/// <param name="deepSaveType">DeepSaveType Enumeration to Include/Exclude object property collections from Save.</param>
		/// <param name="childTypes">CashTransfer Property Collection Type Array To Include or Exclude from Save</param>
		[DataObjectMethod(DataObjectMethodType.Update)]
		public override bool DeepSave(TList<CashTransfer> entityCollection, DeepSaveType deepSaveType, params System.Type[] childTypes)
		{	
			#region Security and validation check
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("DeepSave");
			...
			try
            {
				...
				result = dataProvider.CashTransferProvider.DeepSave(transactionManager, entityCollection,  deepSaveType, childTypes);
