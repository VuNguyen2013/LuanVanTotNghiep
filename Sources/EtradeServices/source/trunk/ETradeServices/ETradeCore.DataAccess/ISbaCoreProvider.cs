...
namespace ETradeCore.DataAccess
{
    ...
    public interface ISbaCoreProvider
    {
        ...
        List<BuyRight> GetListBuyRight(string accountNo, string tradeDate);
        /// <summary>
        ...
        /// <returns></returns>
        MaginSecInfo GetMaginSecInfo(string tradeDate,string symbol);


        /// <summary>
        /// Gets the list cap fund info.
        /// </summary>
        /// <returns></returns>
        CapFundInfo GetCapFundInfo();
    }
}