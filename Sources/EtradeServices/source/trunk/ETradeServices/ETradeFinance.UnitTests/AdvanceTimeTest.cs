...
namespace ETradeFinance.UnitTests
{
    ...
    {    	
		/// <summary>
		/// Creates a new <see cref="AdvanceTimeTest"/> instance.
		/// </summary>	
		public AdvanceTimeTest()
		{				
		}
		...
		/// <summary>
		/// Selects a sample of  AdvanceTime objects of the database.
		/// </summary>
		[NUnit.Framework.Test]
        ...
        ///</summary>
        static public AdvanceTime CreateMockInstance(TransactionManager tm)
        {
            // get the default mock instance
            AdvanceTime mock = AdvanceTimeTest.CreateMockInstance_Generated(tm);
        ...
        ///</summary>
        static public void UpdateMockInstance(TransactionManager tm, AdvanceTime mock)
        {
            AdvanceTimeTest.UpdateMockInstance_Generated(tm, mock);
        ...
        static private void SetSpecialTestData(AdvanceTime mock)
        {
