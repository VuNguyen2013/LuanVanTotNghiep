    ...
    public class Global : HttpApplication
    {
        ...
        protected void Application_Start(object sender, EventArgs e)
        {
            try
            {
                ...
                MarketServices.HandleHOSECheckConditionOrderEvent += etradeServices.CheckHOSEConditionOrder;
                MarketServices.HandleHNXCheckConditionOrderEvent += etradeServices.CheckHNXConditionOrder;
                MarketServices.HandleUPCOMCheckConditionOrderEvent += etradeServices.CheckUPCOMConditionOrder;

                MarketServices.StartSessionThread();
                ...
                //Update expired data
                conditionOrderService.UpdateExpiredData(0);
