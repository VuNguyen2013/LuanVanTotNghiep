...
namespace ETradeHistory.UnitTests
{
    ...
    {    	
		/// <summary>
		/// Creates a new <see cref="TradedHistoryTest"/> instance.
		/// </summary>	
		public TradedHistoryTest()
		{				
		}
		...
		/// <summary>
		/// Selects a sample of  TradedHistory objects of the database.
		/// </summary>
		[NUnit.Framework.Test]
        ...
        ///</summary>
        static public TradedHistory CreateMockInstance(TransactionManager tm)
        {
            // get the default mock instance
            TradedHistory mock = TradedHistoryTest.CreateMockInstance_Generated(tm);
        ...
        ///</summary>
        static public void UpdateMockInstance(TransactionManager tm, TradedHistory mock)
        {
            TradedHistoryTest.UpdateMockInstance_Generated(tm, mock);
        ...
        static private void SetSpecialTestData(TradedHistory mock)
        {
