...
namespace ETradeOrders.UnitTests
{
    ...
    {    	
		/// <summary>
		/// Creates a new <see cref="ExecOrderTest"/> instance.
		/// </summary>	
		public ExecOrderTest()
		{				
		}
		...
		/// <summary>
		/// Selects a sample of  ExecOrder objects of the database.
		/// </summary>
		[NUnit.Framework.Test]
        ...
        ///</summary>
        static public ExecOrder CreateMockInstance(TransactionManager tm)
        {
            // get the default mock instance
            ExecOrder mock = ExecOrderTest.CreateMockInstance_Generated(tm);
        ...
        ///</summary>
        static public void UpdateMockInstance(TransactionManager tm, ExecOrder mock)
        {
            ExecOrderTest.UpdateMockInstance_Generated(tm, mock);
        ...
        static private void SetSpecialTestData(ExecOrder mock)
        {
