...
/*
	...
	Important: Do not modify this file. Edit the file SqlTradedHistoryProvider.cs instead.
*/
...
namespace ETradeHistory.DataAccess.SqlClient
{
	...
	///</summary>
	public abstract partial class SqlTradedHistoryProviderBase : TradedHistoryProviderBase
	{
		#region Declarations
		...
		/// <summary>
		/// Creates a new <see cref="SqlTradedHistoryProviderBase"/> instance.
		/// </summary>
		public SqlTradedHistoryProviderBase()
		{
		}
	...
	public SqlTradedHistoryProviderBase(string connectionString, bool useStoredProcedure, string providerInvariantName)
	{
    ...
    public string ProviderInvariantName
    {
		...
		public override bool Delete(TransactionManager transactionManager, long _id)
		{
			...
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.TradedHistory_Delete", _useStoredProcedure);
			...
			{
				string entityKey = EntityLocator.ConstructKeyFromPkItems(typeof(TradedHistory)
					,_id);
		...
		/// <returns>Returns a typed collection of ETradeHistory.Entities.TradedHistory objects.</returns>
		public override TList<TradedHistory> Find(TransactionManager transactionManager, string whereClause, int start, int pageLength, out int count)
		{
			count = -1;
			if (whereClause.IndexOf(";") > -1)
				return new TList<TradedHistory>();
	
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.TradedHistory_Find", _useStoredProcedure);
		...
		database.AddInParameter(commandWrapper, "@ExecutedVol", DbType.Int64, DBNull.Value);
		database.AddInParameter(commandWrapper, "@ExecutedPrice", DbType.Decimal, DBNull.Value);
		database.AddInParameter(commandWrapper, "@CancelledVolume", DbType.Int64, DBNull.Value);
		...
		database.AddInParameter(commandWrapper, "@CancelledRejReason", DbType.Int32, DBNull.Value);
		...
		database.AddInParameter(commandWrapper, "@MaxValue", DbType.Decimal, DBNull.Value);
	   		...
	   		foreach (string clause in clauses)
			{
				...
				if (clause.Trim().StartsWith("cancelledrejreason ") || clause.Trim().StartsWith("cancelledrejreason="))
				{
					database.SetParameterValue(commandWrapper, "@CancelledRejReason", 
			...
			//Create Collection
			TList<TradedHistory> rows = new TList<TradedHistory>();
		...
		/// <param name="count">out. The number of rows that match this query.</param>
		/// <returns>Returns a typed collection of ETradeHistory.Entities.TradedHistory objects.</returns>
		public override TList<TradedHistory> Find(TransactionManager transactionManager, IFilterParameterCollection parameters, string orderBy, int start, int pageLength, out int count)
		{
			...
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.TradedHistory_Find_Dynamic", typeof(TradedHistoryColumn), filter, orderBy, start, pageLength);
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override TList<TradedHistory> GetAll(TransactionManager transactionManager, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.TradedHistory_Get_List", _useStoredProcedure);
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of ETradeHistory.Entities.TradedHistory objects.</returns>
		public override TList<TradedHistory> GetPaged(TransactionManager transactionManager, string whereClause, string orderBy, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.TradedHistory_GetPaged", _useStoredProcedure);
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override ETradeHistory.Entities.TradedHistory GetById(TransactionManager transactionManager, long _id, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.TradedHistory_GetById", _useStoredProcedure);
			
				database.AddInParameter(commandWrapper, "@Id", DbType.Int64, _id);
			
			IDataReader reader = null;
			TList<TradedHistory> tmp = new TList<TradedHistory>();
			try
			{
				//Provider Data Requesting Command Event
		...
		/// <remarks>
		///		After inserting into the datasource, the ETradeHistory.Entities.TradedHistory object will be updated
		/// 	to refelect any changes made by the datasource. (ie: identity or computed columns)
		/// </remarks>	
		public override void BulkInsert(TransactionManager transactionManager, TList<ETradeHistory.Entities.TradedHistory> entities)
		{
			...
			bulkCopy.DestinationTableName = "TradedHistory";
			...
			DataColumn col2 = dataTable.Columns.Add("SubCustAccountID", typeof(string));
			col2.AllowDBNull = false;		
			DataColumn col3 = dataTable.Columns.Add("Type", typeof(string));
			col3.AllowDBNull = true;		
			DataColumn col4 = dataTable.Columns.Add("FISOrderID", typeof(System.Int32?));
			col4.AllowDBNull = true;		
			DataColumn col5 = dataTable.Columns.Add("SecSymbol", typeof(string));
			col5.AllowDBNull = false;		
			DataColumn col6 = dataTable.Columns.Add("Side", typeof(string));
			col6.AllowDBNull = false;		
			DataColumn col7 = dataTable.Columns.Add("Price", typeof(decimal));
			col7.AllowDBNull = false;		
			DataColumn col8 = dataTable.Columns.Add("ConPrice", typeof(string));
			col8.AllowDBNull = true;		
			DataColumn col9 = dataTable.Columns.Add("Volume", typeof(long));
			col9.AllowDBNull = false;		
			DataColumn col10 = dataTable.Columns.Add("ExecutedVol", typeof(System.Int64?));
			col10.AllowDBNull = true;		
			DataColumn col11 = dataTable.Columns.Add("ExecutedPrice", typeof(System.Decimal?));
			col11.AllowDBNull = true;		
			DataColumn col12 = dataTable.Columns.Add("CancelledVolume", typeof(System.Int64?));
			col12.AllowDBNull = true;		
			DataColumn col13 = dataTable.Columns.Add("MatchedTime", typeof(System.DateTime?));
			col13.AllowDBNull = true;		
			DataColumn col14 = dataTable.Columns.Add("CancelledTime", typeof(System.DateTime?));
			col14.AllowDBNull = true;		
			DataColumn col15 = dataTable.Columns.Add("OrdRejReason", typeof(System.Int32?));
			col15.AllowDBNull = true;		
			DataColumn col16 = dataTable.Columns.Add("CancelledRejReason", typeof(System.Int32?));
			col16.AllowDBNull = true;		
			DataColumn col17 = dataTable.Columns.Add("SourceID", typeof(System.Int16?));
			col17.AllowDBNull = true;		
			DataColumn col18 = dataTable.Columns.Add("Market", typeof(string));
			col18.AllowDBNull = false;		
			DataColumn col19 = dataTable.Columns.Add("RefOrderID", typeof(string));
			col19.AllowDBNull = true;		
			DataColumn col20 = dataTable.Columns.Add("EffDate", typeof(System.DateTime?));
			col20.AllowDBNull = true;		
			DataColumn col21 = dataTable.Columns.Add("ExpDate", typeof(System.DateTime?));
			col21.AllowDBNull = true;		
			DataColumn col22 = dataTable.Columns.Add("MinValue", typeof(System.Decimal?));
			col22.AllowDBNull = true;		
			DataColumn col23 = dataTable.Columns.Add("MaxValue", typeof(System.Decimal?));
			...
			bulkCopy.ColumnMappings.Add("CancelledRejReason", "CancelledRejReason");
			...
			foreach(ETradeHistory.Entities.TradedHistory entity in entities)
			{
				...
				DataRow row = dataTable.NewRow();
					...
					row["CancelledRejReason"] = entity.CancelledRejReason.HasValue ? (object) entity.CancelledRejReason  : System.DBNull.Value;
		...
		/// <summary>
		/// 	Inserts a ETradeHistory.Entities.TradedHistory object into the datasource using a transaction.
		/// </summary>
		/// <param name="transactionManager"><see cref="TransactionManager"/> object</param>
		/// <param name="entity">ETradeHistory.Entities.TradedHistory object to insert.</param>
		/// <remarks>
		///		After inserting into the datasource, the ETradeHistory.Entities.TradedHistory object will be updated
		/// 	to refelect any changes made by the datasource. (ie: identity or computed columns)
		/// </remarks>	
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override bool Insert(TransactionManager transactionManager, ETradeHistory.Entities.TradedHistory entity)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.TradedHistory_Insert", _useStoredProcedure);
			...
			database.AddInParameter(commandWrapper, "@Volume", DbType.Int64, entity.Volume );
			database.AddInParameter(commandWrapper, "@ExecutedVol", DbType.Int64, (entity.ExecutedVol.HasValue ? (object) entity.ExecutedVol  : System.DBNull.Value));
			...
			database.AddInParameter(commandWrapper, "@CancelledVolume", DbType.Int64, (entity.CancelledVolume.HasValue ? (object) entity.CancelledVolume  : System.DBNull.Value));
			...
			database.AddInParameter(commandWrapper, "@CancelledRejReason", DbType.Int32, (entity.CancelledRejReason.HasValue ? (object) entity.CancelledRejReason  : System.DBNull.Value));
		...
		/// </summary>
		/// <param name="transactionManager"><see cref="TransactionManager"/> object</param>
		/// <param name="entity">ETradeHistory.Entities.TradedHistory object to update.</param>
		/// <remarks>
		///		After updating the datasource, the ETradeHistory.Entities.TradedHistory object will be updated
		/// 	to refelect any changes made by the datasource. (ie: identity or computed columns)
		/// </remarks>
		/// <returns>Returns true if operation is successful.</returns>
        /// <exception cref="System.Exception">The command could not be executed.</exception>
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override bool Update(TransactionManager transactionManager, ETradeHistory.Entities.TradedHistory entity)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.TradedHistory_Update", _useStoredProcedure);
