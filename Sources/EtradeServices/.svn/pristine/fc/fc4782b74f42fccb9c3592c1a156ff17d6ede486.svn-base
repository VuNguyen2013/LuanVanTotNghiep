...
namespace ETradeCoreDB.Helper
{
    ...
    {
        private static readonly ILog Logger = LogManager.GetLogger(typeof(DaoCommon));
        ...
        public static OdbcConnection Connect()
        {
            ...
            {
                Logger.Error("Connect: EXCEPTION, ex = " + e.StackTrace);
                return null;
            }
        }//Connect
        ...
        public static void DisConnect(OdbcConnection conn, OdbcDataReader dataReader)
        {
            ...
            {
                Logger.Error("Error disconnect database" + ":" + e.StackTrace);
            }
        }//Disconnect
