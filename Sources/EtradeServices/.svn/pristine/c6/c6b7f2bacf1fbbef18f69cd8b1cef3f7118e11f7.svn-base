...
{	
	...
	{		
		...
		/// <returns>Returns true if operation suceeded.</returns>
		public bool Delete(System.Int64 _feeId)
		{
		...
		/// <remarks>Deletes based on primary key(s).</remarks>
		/// <returns>Returns true if operation suceeded.</returns>
		public abstract bool Delete(TransactionManager transactionManager, System.Int64 _feeId);		
		...
		public ETradeFinance.Entities.Fee GetByFeeId(System.Int64 _feeId)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="ETradeFinance.Entities.Fee"/> class.</returns>
		public ETradeFinance.Entities.Fee GetByFeeId(System.Int64 _feeId, int start, int pageLength)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="ETradeFinance.Entities.Fee"/> class.</returns>
		public ETradeFinance.Entities.Fee GetByFeeId(TransactionManager transactionManager, System.Int64 _feeId)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="ETradeFinance.Entities.Fee"/> class.</returns>
		public ETradeFinance.Entities.Fee GetByFeeId(TransactionManager transactionManager, System.Int64 _feeId, int start, int pageLength)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="ETradeFinance.Entities.Fee"/> class.</returns>
		public ETradeFinance.Entities.Fee GetByFeeId(System.Int64 _feeId, int start, int pageLength, out int count)
		{
			return GetByFeeId(null, _feeId, start, pageLength, out count);
		}
		...
		/// <returns>Returns an instance of the <see cref="ETradeFinance.Entities.Fee"/> class.</returns>
		public abstract ETradeFinance.Entities.Fee GetByFeeId(TransactionManager transactionManager, System.Int64 _feeId, int start, int pageLength, out int count);
		...
		public static TList<Fee> Fill(IDataReader reader, TList<Fee> rows, int start, int pageLength)
		{
			...
			for (int i = 0; i < pageLength; i++)
			{
				...
				if (useEntityFactory)
				{
					...
					.Append("|").Append((System.Int64)reader[((int)FeeColumn.FeeId - 1)]).ToString();
					...
					))
				{
					...
					c.FeeId = (System.Int64)reader[((int)FeeColumn.FeeId - 1)];
					c.MinValue = (System.Decimal)reader[((int)FeeColumn.MinValue - 1)];
					...
					c.FeeRatio = (System.Decimal)reader[((int)FeeColumn.FeeRatio - 1)];
		...
		public static void RefreshEntity(IDataReader reader, ETradeFinance.Entities.Fee entity)
		{
			...
			entity.FeeId = (System.Int64)reader[((int)FeeColumn.FeeId - 1)];
			entity.MinValue = (System.Decimal)reader[((int)FeeColumn.MinValue - 1)];
			...
			entity.FeeRatio = (System.Decimal)reader[((int)FeeColumn.FeeRatio - 1)];
		...
		public static void RefreshEntity(DataSet dataSet, ETradeFinance.Entities.Fee entity)
		{
			...
			entity.FeeId = (System.Int64)dataRow["FeeID"];
			entity.MinValue = (System.Decimal)dataRow["MinValue"];
			...
			entity.FeeRatio = (System.Decimal)dataRow["FeeRatio"];
