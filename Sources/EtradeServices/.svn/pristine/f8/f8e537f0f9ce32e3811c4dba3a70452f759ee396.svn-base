...
namespace ETradeCore.UnitTests
{
    ...
    public class CashAdvanceServicesTest
    {
        ...
        public void GetAdvanceInfo()
        {
            ...
            ETradeWebServices.Services.ETradeServices.SaveHolidayConfig(holidayses);
            ...
            ETradeWebServices.Services.ETradeServices.SaveWorkingDaysConfig(workingDayses);

            var configurationses = new List<Configurations>();
            ETradeWebServices.Services.ETradeServices.SaveAllConfiguration(configurationses);
            ...
            List<AdvanceInfo> resultObject = cashAdvanceServices.GetAdvanceInfo(
                ...
                new NewestWorkingDatesInfo
                    ...
                    null, SysConfig.Holidays, SysConfig.WorkingDays
                    );
        ...
        {
            var eTradeServices = new ETradeWebServices.Services.ETradeServices();
